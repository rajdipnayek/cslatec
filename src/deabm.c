/* deabm.f -- translated by f2c (version 12.02.01).
...
/* DECK DEABM */
/* Subroutine */ int deabm_(U_fp f, integer *neq, real *t, real *y, real *
	...
	integer *ipar)
{
    ...
    /* Local variables */
    static integer ig, ip, iv, iw, igi;
    extern /* Subroutine */ int des_(U_fp, integer *, real *, real *, real *, 
    ...
    static integer iyp, iwt, iyy, iphi, isig, ipsi;
    static char xern1[8], xern3[16];
    static integer ibeta, ihold;
    static logical stiff;
    static integer itold, ixold;
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "DEABM", ch__1, &c__13, &c__2, (ftnlen)6, (
		    ftnlen)5, (ftnlen)223);
	    return 0;
	}
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DEABM", ch__2, &c__1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)106);
	*idid = -33;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DEABM", ch__3, &c__2, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)96);
	*idid = -33;
    }
...
L50:
    des_((U_fp)f, neq, t, &y[1], tout, &info[1], &rtol[1], &atol[1], idid, &
