/* la05bs.f -- translated by f2c (version 12.02.01).
...
/* DECK LA05BS */
/* Subroutine */ int la05bs_(real *a, integer *ind, integer *ia, integer *n, 
	integer *ip, integer *iw, real *w, real *g, real *b, logical *trans)
{
...
L130:
    xsetun_(&la05ds_1.lp);
    if (la05ds_1.lp > 0) {
	xermsg_("SLATEC", "LA05BS", "EARLIER ENTRY GAVE ERROR RETURN.", &c_n8,
