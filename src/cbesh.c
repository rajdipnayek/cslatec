/* cbesh.f -- translated by f2c (version 12.02.01).
...
/* DECK CBESH */
/* Subroutine */ int cbesh_(complex *z__, real *fnu, integer *kode, integer *
	m, integer *n, complex *cy, integer *nz, integer *ierr)
{
    /* Initialized data */
    ...
    static real aa, bb, fn;
    static integer mm;
    static real az;
    static integer ir;
    static real rl;
    static integer mr, nn, nw;
    static real xn, yn;
    static complex zn, zt;
    static real xx, yy, dig, arg, aln, fmm, cpn, r1m5, ufl, sgn;
    static integer nuf, inu;
    static real tol, spn, alim, elim;
    static complex csgn;
    static real atol, rhpi;
    static integer inuh;
    ...
    extern /* Subroutine */ int cbknu_(complex *, real *, integer *, integer *
	    , complex *, integer *, real *, real *, real *), cbunk_(complex *,
	     real *, integer *, integer *, integer *, complex *, integer *, 
	    real *, real *, real *), cuoik_(complex *, real *, integer *, 
...
L80:
    mr = -mm;
    cacon_(&zn, fnu, kode, &mr, &nn, &cy[1], &nw, &rl, &fnul, &tol, &elim, &
	    alim);
    if (nw < 0) {
	goto L230;
    }
...
L125:
	...
	zn.r = q__1.r, zn.i = q__1.i;
	i__2 = i__;
	q__2.r = atol, q__2.i = 0.f;
	q__1.r = zn.r * q__2.r - zn.i * q__2.i, q__1.i = zn.r * q__2.i + zn.i 
		* q__2.r;
	cy[i__2].r = q__1.r, cy[i__2].i = q__1.i;
	q__1.r = csgn.r * zt.r - csgn.i * zt.i, q__1.i = csgn.r * zt.i + 
		csgn.i * zt.r;
	csgn.r = q__1.r, csgn.i = q__1.i;
/* L120: */
    }
