/* isdcg.f -- translated by f2c (version 12.02.01).
...
/* DECK ISDCG */
integer isdcg_(integer *n, doublereal *b, doublereal *x, integer *nelt, 
	...
	doublereal *z__, doublereal *p, doublereal *dz, doublereal *rwork, 
