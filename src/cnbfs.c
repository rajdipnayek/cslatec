/* cnbfs.f -- translated by f2c (version 12.02.01).
...
/* DECK CNBFS */
/* Subroutine */ int cnbfs_(complex *abe, integer *lda, integer *n, integer *
	...
	work, integer *iwork)
{
    ...
    extern /* Subroutine */ int cnbco_(complex *, integer *, integer *, 
	    integer *, integer *, integer *, real *, complex *), cnbsl_(
	    complex *, integer *, integer *, integer *, integer *, integer *, 
	    complex *, integer *);
    static real rcond;
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "CNBFS", ch__1, &c_n1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)40);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "CNBFS", ch__2, &c_n2, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)27);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "CNBFS", ch__3, &c_n3, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)31);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "CNBFS", ch__4, &c_n5, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)29);
	return 0;
    }
...
/* Writing concatenation */
	...
	i__2[2] = 16, a__2[2] = " IS OUT OF RANGE";
	s_cat(ch__4, a__2, i__2, &c__3, (ftnlen)29);
	xermsg_("SLATEC", "CNBFS", ch__4, &c_n6, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)29);
	return 0;
    }
...
/*        FACTOR MATRIX A INTO LU */
	...
	cnbco_(&abe[abe_offset], lda, n, ml, mu, &iwork[1], &rcond, &work[1]);

/*        CHECK FOR COMPUTATIONALLY SINGULAR MATRIX */

	if (rcond == 0.f) {
	    *ind = -4;
	    xermsg_("SLATEC", "CNBFS", "SINGULAR MATRIX A - NO SOLUTION", &
...
/*        AND CHECK FOR IND GREATER THAN ZERO */
	...
	*ind = -r_lg10(&r__1);
	if (*ind <= 0) {
	    *ind = -10;
	    xermsg_("SLATEC", "CNBFS", "SOLUTION MAY HAVE NO SIGNIFICANCE", &
...
/*     SOLVE AFTER FACTORING */
    ...
    cnbsl_(&abe[abe_offset], lda, n, ml, mu, &iwork[1], &v[1], &c__0);
    return 0;
} /* cnbfs_ */
