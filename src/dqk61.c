/* dqk61.f -- translated by f2c (version 12.02.01).
	...
	result, doublereal *abserr, doublereal *resabs, doublereal *resasc)
{
    ...
    /* Local variables */
    static integer j;
    static doublereal fc, fv1[30], fv2[30];
    static integer jtw;
    static doublereal resg, resk, fsum, fval1, fval2;
    static integer jtwm1;
    static doublereal dabsc, hlgth, centr, reskh, uflow;
