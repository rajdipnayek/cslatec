/* dwritp.f -- translated by f2c (version 12.02.01).
...
/* DECK DWRITP */
/* Subroutine */ int dwritp_(integer *ipage, integer *list, doublereal *rlist,
