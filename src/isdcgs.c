/* isdcgs.f -- translated by f2c (version 12.02.01).
...
/* DECK ISDCGS */
integer isdcgs_(integer *n, doublereal *b, doublereal *x, integer *nelt, 
	integer *ia, integer *ja, doublereal *a, integer *isym, S_fp matvec, 
	S_fp msolve, integer *itol, doublereal *tol, integer *itmax, integer *
	iter, doublereal *err, integer *ierr, integer *iunit, doublereal *r__,
	 doublereal *r0, doublereal *p, doublereal *q, doublereal *u, 
	doublereal *v1, doublereal *v2, doublereal *rwork, integer *iwork, 
...
/*         err = ||x-TrueSolution||/||TrueSolution|| (2-Norms). */
	...
	i__1 = *n;
	for (i__ = 1; i__ <= i__1; ++i__) {
	    v2[i__] = x[i__] - dslblk_1.soln[i__ - 1];
/* L10: */
	}
	*err = dnrm2_(n, &v2[1], &c__1) / *solnrm;
    } else {
