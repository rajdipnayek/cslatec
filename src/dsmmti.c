/* dsmmti.f -- translated by f2c (version 12.02.01).
...
/* DECK DSMMTI */
/* Subroutine */ int dsmmti_(integer *n, doublereal *b, doublereal *x, 
	 ...
	 doublereal *rwork, integer *iwork)
{
    ...
    extern /* Subroutine */ int dsmmi2_(integer *, doublereal *, doublereal *,
...
/*         factorization. */
    ...
    dsmmi2_(n, &b[1], &x[1], &iwork[locil], &iwork[locjl], &rwork[locl], &
