/* dfspvd.f -- translated by f2c (version 12.02.01).
...
/* DECK DFSPVD */
/* Subroutine */ int dfspvd_(doublereal *t, integer *k, doublereal *x, 
	integer *ileft, doublereal *vnikx, integer *nderiv)
{
    /* System generated locals */
    integer vnikx_dim1, vnikx_offset, i__1, i__2, i__3;

    /* Local variables */
    static doublereal a[400]	/* was [20][20] */;
    static integer i__, j, l, m;
    static doublereal v;
    static integer jm1, kmd;
    static doublereal diff, fkmd;
...
/* ***FIRST EXECUTABLE STATEMENT  DFSPVD */
    ...
    /* Function Body */
    i__1 = *k + 1 - *nderiv;
    dfspvn_(&t[1], &i__1, &c__1, x, ileft, &vnikx[*nderiv + *nderiv * 
	    vnikx_dim1]);
    if (*nderiv <= 1) {
	goto L99;
    }
...
/* L11: */
	...
	ideriv = idervm;
	dfspvn_(&t[1], &c__0, &c__2, x, ileft, &vnikx[ideriv + ideriv * 
		vnikx_dim1]);
/* L15: */
    }
