/* derkf.f -- translated by f2c (version 12.02.01).
...
/* DECK DERKF */
/* Subroutine */ int derkf_(U_fp f, integer *neq, real *t, real *y, real *
	...
	integer *ipar)
{
    ...
    char ch__1[224], ch__2[98], ch__3[89];

    /* Local variables */
    static integer kh, ku, kf1, kf2, kf3, kf4, kf5, kdi, ktf, kto, kyp, kys, 
	    krer;
    static char xern1[8], xern3[16];
    static logical stiff;
    extern /* Subroutine */ int derkfs_(U_fp, integer *, real *, real *, real 
	    *, integer *, real *, real *, integer *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, real *, integer *, integer *, integer *, integer *, 
	    logical *, logical *, integer *, integer *, real *, integer *), 
	    xermsg_(char *, char *, char *, integer *, integer *, ftnlen, 
	    ftnlen, ftnlen);
    static logical nonstf;
    static integer ktstar;
...
/* Writing concatenation */
	    i__1[0] = 83, a__1[0] = "AN APPARENT INFINITE LOOP HAS BEEN DETE"
	    ...
	    s_cat(ch__1, a__1, i__1, &c__5, (ftnlen)224);
	    xermsg_("SLATEC", "DERKF", ch__1, &c__13, &c__2, (ftnlen)6, (
		    ftnlen)5, (ftnlen)224);
	    return 0;
	}
    }
...
/*     CHECK LRW AND LIW FOR SUFFICIENT STORAGE ALLOCATION */
    ...
    *idid = 0;
	...
	e_wsfi();
/* Writing concatenation */
	i__2[0] = 90, a__2[0] = "LENGTH OF RWORK ARRAY MUST BE AT LEAST  30 "
		"+ 7*NEQ.  YOU HAVE CALLED THE CODE WITH  LRW = ";
	i__2[1] = 8, a__2[1] = xern1;
	s_cat(ch__2, a__2, i__2, &c__2, (ftnlen)98);
	xermsg_("SLATEC", "DERKF", ch__2, &c__1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)98);
	*idid = -33;
    }
	...
	e_wsfi();
/* Writing concatenation */
	i__2[0] = 81, a__2[0] = "LENGTH OF IWORK ARRAY MUST BE AT LEAST  34."
		"  YOU HAVE CALLED THE CODE WITH LIW = ";
	i__2[1] = 8, a__2[1] = xern1;
	s_cat(ch__3, a__2, i__2, &c__2, (ftnlen)89);
	xermsg_("SLATEC", "DERKF", ch__3, &c__2, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)89);
	*idid = -33;
    }
...
/* ********************************************************************** */
    ...
    derkfs_((U_fp)f, neq, t, &y[1], tout, &info[1], &rtol[1], &atol[1], idid, 
	    &rwork[kh], &rwork[ktf], &rwork[kyp], &rwork[kf1], &rwork[kf2], &
	    rwork[kf3], &rwork[kf4], &rwork[kf5], &rwork[kys], &rwork[kto], &
	    rwork[kdi], &rwork[ku], &rwork[krer], &iwork[21], &iwork[22], &
	    iwork[23], &iwork[24], &stiff, &nonstf, &iwork[27], &iwork[28], &
	    rpar[1], &ipar[1]);
