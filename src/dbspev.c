/* dbspev.f -- translated by f2c (version 12.02.01).
...
/* DECK DBSPEV */
/* Subroutine */ int dbspev_(doublereal *t, doublereal *ad, integer *n, 
	integer *k, integer *nderiv, doublereal *x, integer *inev, doublereal 
	*svalue, doublereal *work)
{
    ...
    static integer left, kp1mn, mflag, iwork;
    extern /* Subroutine */ int dbspvn_(doublereal *, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, doublereal *, 
	    integer *), xermsg_(char *, char *, char *, integer *, integer *, 
	    ftnlen, ftnlen, ftnlen), dintrv_(doublereal *, integer *, 
...
/* ***FIRST EXECUTABLE STATEMENT  DBSPEV */
    ...
    id = *nderiv;
    i__1 = *n + 1;
    dintrv_(&t[1], &i__1, x, inev, &i__, &mflag);
    if (*x < t[*k]) {
	goto L110;
    }
    if (mflag == 0) {
...
L30:
    kp1mn = *k + 1 - id;
    kp1 = *k + 1;
    dbspvn_(&t[1], &kp1mn, k, &c__1, x, &i__, &work[1], &work[kp1], &iwork);
    jj = (*n + *n - id + 2) * (id - 1) / 2;
...
/* L50: */
    ...
    jj -= *n - id + 1;
    ++kp1mn;
    dbspvn_(&t[1], &kp1mn, k, &c__2, x, &i__, &work[1], &work[kp1], &iwork);
    goto L40;
...
L100:
    xermsg_("SLATEC", "DBSPEV", "K DOES NOT SATISFY K.GE.1", &c__2, &c__1, (
	    ftnlen)6, (ftnlen)6, (ftnlen)25);
    return 0;
L105:
    xermsg_("SLATEC", "DBSPEV", "N DOES NOT SATISFY N.GE.K", &c__2, &c__1, (
	    ftnlen)6, (ftnlen)6, (ftnlen)25);
    return 0;
L110:
    xermsg_("SLATEC", "DBSPEV", "X IS NOT IN T(K).LE.X.LE.T(N+1)", &c__2, &
	    c__1, (ftnlen)6, (ftnlen)6, (ftnlen)31);
    return 0;
L115:
    xermsg_("SLATEC", "DBSPEV", "NDERIV DOES NOT SATISFY 1.LE.NDERIV.LE.K", &
	    c__2, &c__1, (ftnlen)6, (ftnlen)6, (ftnlen)40);
    return 0;
L120:
    xermsg_("SLATEC", "DBSPEV", "A LEFT LIMITING VALUE CANNOT BE OBTAINED AT"
