/* isdomn.f -- translated by f2c (version 12.02.01).
...
/* DECK ISDOMN */
integer isdomn_(integer *n, doublereal *b, doublereal *x, integer *nelt, 
	...
	doublereal *r__, doublereal *z__, doublereal *p, doublereal *ap, 
	doublereal *emap, doublereal *dz, doublereal *csav, doublereal *rwork,
	 integer *iwork, doublereal *ak, doublereal *bnrm, doublereal *solnrm)
{
    /* Format strings */
