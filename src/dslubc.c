/* dslubc.f -- translated by f2c (version 12.02.01).
...
/* DECK DSLUBC */
/* Subroutine */ int dslubc_(integer *n, doublereal *b, doublereal *x, 
	...
	integer *lenw, integer *iwork, integer *leniw)
{
    ...
    extern /* Subroutine */ int ds2y_(integer *, integer *, integer *, 
	    integer *, doublereal *, integer *), dbcg_(integer *, doublereal *
	    , doublereal *, integer *, integer *, integer *, doublereal *, 
	    integer *, U_fp, U_fp, U_fp, U_fp, integer *, doublereal *, 
...
/*         Check the workspace allocations. */
    dchkw_("DSLUBC", &lociw, leniw, &locw, lenw, ierr, iter, err, (ftnlen)6);
    if (*ierr != 0) {
	return 0;
    }
...
/*         BiConjugate Gradient algorithm. */
    dbcg_(n, &b[1], &x[1], nelt, &ia[1], &ja[1], &a[1], isym, (U_fp)dsmv_, (
	    U_fp)dsmtv_, (U_fp)dslui_, (U_fp)dsluti_, itol, tol, itmax, iter, 
