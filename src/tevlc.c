/* tevlc.f -- translated by f2c (version 12.02.01).
...
/* DECK TEVLC */
/* Subroutine */ int tevlc_(integer *n, real *d__, real *e2, integer *ierr)
{
...
/* L101: */
    ...
    for (l = 1; l <= i__1; ++l) {
	j = 0;
	h__ = ccblk_1.machep * ((r__1 = d__[l], dabs(r__1)) + sqrt(e2[l]));
	if (b > h__) {
	    goto L102;
	}
	b = h__;
