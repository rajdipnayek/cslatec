/* dnbfs.f -- translated by f2c (version 12.02.01).
...
/* DECK DNBFS */
/* Subroutine */ int dnbfs_(doublereal *abe, integer *lda, integer *n, 
	integer *ml, integer *mu, doublereal *v, integer *itask, integer *ind,
	 doublereal *work, integer *iwork)
{
    ...
    extern /* Subroutine */ int dnbco_(doublereal *, integer *, integer *, 
	    integer *, integer *, integer *, doublereal *, doublereal *), 
	    dnbsl_(doublereal *, integer *, integer *, integer *, integer *, 
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DNBFS", ch__1, &c_n1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)40);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DNBFS", ch__2, &c_n2, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)27);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DNBFS", ch__3, &c_n3, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)31);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DNBFS", ch__4, &c_n5, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)29);
	return 0;
    }
...
/* Writing concatenation */
	...
	i__2[2] = 16, a__2[2] = " IS OUT OF RANGE";
	s_cat(ch__4, a__2, i__2, &c__3, (ftnlen)29);
	xermsg_("SLATEC", "DNBFS", ch__4, &c_n6, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)29);
	return 0;
    }
...
/*        FACTOR MATRIX A INTO LU */
	...
	dnbco_(&abe[abe_offset], lda, n, ml, mu, &iwork[1], &rcond, &work[1]);

/*        CHECK FOR COMPUTATIONALLY SINGULAR MATRIX */

	if (rcond == 0.) {
	    *ind = -4;
	    xermsg_("SLATEC", "DNBFS", "SINGULAR MATRIX A - NO SOLUTION", &
...
/*        AND CHECK FOR IND GREATER THAN ZERO */
	...
	*ind = (integer) (-d_lg10(&d__1));
	if (*ind <= 0) {
	    *ind = -10;
	    xermsg_("SLATEC", "DNBFS", "SOLUTION MAY HAVE NO SIGNIFICANCE", &
...
/*     SOLVE AFTER FACTORING */
    ...
    dnbsl_(&abe[abe_offset], lda, n, ml, mu, &iwork[1], &v[1], &c__0);
    return 0;
} /* dnbfs_ */
