/* sglss.f -- translated by f2c (version 12.02.01).
...
/* DECK SGLSS */
/* Subroutine */ int sglss_(real *a, integer *mda, integer *m, integer *n, 
	real *b, integer *mdb, integer *nb, real *rnorm, real *work, integer *
	lw, integer *iwork, integer *liw, integer *info)
{
    ...
    /* Local variables */
    static real ae, re;
    static integer np, key, mode;
    extern /* Subroutine */ int llsia_(real *, integer *, integer *, integer *
	    , real *, integer *, integer *, real *, real *, integer *, 
	    integer *, integer *, integer *, integer *, real *, real *, 
	    integer *, integer *, integer *, integer *);
    static integer krank;
    extern /* Subroutine */ int ulsia_(real *, integer *, integer *, integer *
	    , real *, integer *, integer *, real *, real *, integer *, 
	    integer *, integer *, integer *, integer *, real *, real *, 
	    integer *, integer *, integer *, integer *);
    static integer ksure;
...
/*     IF M.LT.N CALL ULSIA */
    ...
    llsia_(&a[a_offset], mda, m, n, &b[b_offset], mdb, nb, &re, &ae, &key, &
    ...
    *info = *n - krank;
    return 0;
L10:
    ulsia_(&a[a_offset], mda, m, n, &b[b_offset], mdb, nb, &re, &ae, &key, &
	    mode, &np, &krank, &ksure, &rnorm[1], &work[1], lw, &iwork[1], 
	    liw, info);
    if (*info == -1) {
	return 0;
