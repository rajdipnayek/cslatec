/* psi.f -- translated by f2c (version 12.02.01).
...
/* DECK PSI */
doublereal psi_(real *x)
{
    /* Initialized data */

    static real psics[23] = { -.038057080835217922f,.49141539302938713f,
    ...
    static real apsics[16] = { -.0204749044678185f,-.0101801271534859f,
