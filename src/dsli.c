/* dsli.f -- translated by f2c (version 12.02.01).
...
/* DECK DSLI */
/* Subroutine */ int dsli_(integer *n, doublereal *b, doublereal *x, integer *
	nelt, integer *ia, integer *ja, doublereal *a, integer *isym, 
	doublereal *rwork, integer *iwork)
{
    static integer nel;
    extern /* Subroutine */ int dsli2_(integer *, doublereal *, doublereal *, 
...
/* ***FIRST EXECUTABLE STATEMENT  DSLI */
    ...
    locjel = iwork[3];
    locel = iwork[4];
    dsli2_(n, &b[1], &x[1], &nel, &iwork[lociel], &iwork[locjel], &rwork[
	    locel]);
