/* dbsynu.f -- translated by f2c (version 12.02.01).
...
/* DECK DBSYNU */
/* Subroutine */ int dbsynu_(doublereal *x, doublereal *fnu, integer *n, 
	doublereal *y)
{
    /* Initialized data */

    static doublereal x1 = 3.;
    static doublereal x2 = 20.;
    static doublereal pi = 3.14159265358979;
    static doublereal rthpi = .797884560802865;
    static doublereal hpi = 1.5707963267949;
    ...
    /* Local variables */
    static doublereal a[120], f, g;
    static integer i__, j, k;
    static doublereal p, q, s, a1, a2, g1, g2, s1, s2, t1, t2, cb[120], fc, 
	    ak, bk, ck, fk, fn, rb[120];
    static integer kk;
    static doublereal cs, sa, sb, cx;
    static integer nn;
    static doublereal tb, fx, tm, pt, rs, ss, st, rx, cp1, cp2, cs1, cs2, rp1,
	     rp2, rs1, rs2, cbk, cck, arg, rbk, rck, fhs, fks, cpt, dnu, fmu;
    static integer inu;
    static doublereal tol, etx, smu, rpt, dnu2, coef, relb, flrx, etest;
    extern doublereal d1mach_(integer *), dgamma_(doublereal *);
