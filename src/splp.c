/* splp.f -- translated by f2c (version 12.02.01).
...
/* DECK SPLP */
/* Subroutine */ int splp_(U_fp usrmat, integer *mrelas, integer *nvars__, 
	real *costs, real *prgopt, real *dattrv, real *bl, real *bu, integer *
	ind, integer *info, real *primal, real *duals, integer *ibasis, real *
	work, integer *lw, integer *iwork, integer *liw)
{
    ...
    extern /* Subroutine */ int splpmn_(U_fp, integer *, integer *, real *, 
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SPLP", ch__1, &c__5, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)47);
	*info = -5;
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SPLP", ch__2, &c__6, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)46);
	*info = -6;
	return 0;
    }
...
/*     WORKING WITH UNDEFINED DATA. */
    nerr = 14;
    xermsg_("SLATEC", "SPLP", "THE USER OPTION ARRAY HAS UNDEFINED DATA.", &
	    nerr, &iopt, (ftnlen)6, (ftnlen)4, (ftnlen)41);
    *info = -nerr;
    return 0;
L20010:
    if (! (next == 1)) {
...
L10001:
    ...
    nerr = 15;
    xermsg_("SLATEC", "SPLP", "OPTION ARRAY PROCESSING IS CYCLING.", &nerr, &
	    iopt, (ftnlen)6, (ftnlen)4, (ftnlen)35);
    *info = -nerr;
    return 0;
L10002:
    key = prgopt[last + 1];
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SPLP", ch__3, &c__20, &c__1, (ftnlen)6, (ftnlen)4, 
		(ftnlen)60);
	*info = -20;
	return 0;
    }
...
/*     TRIVIAL CHECK ON LENGTH OF LA05*() MATRIX AREA. */
    ...
    nerr = 21;
    xermsg_("SLATEC", "SPLP", "USER-DEFINED VALUE OF LBM MUST BE .GE. 0.", &
	    nerr, &iopt, (ftnlen)6, (ftnlen)4, (ftnlen)41);
    *info = -nerr;
    return 0;
L20022:
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SPLP", ch__4, &c__4, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)82);
	*info = -4;
	return 0;
    }

    splpmn_((U_fp)usrmat, mrelas, nvars__, &costs[1], &prgopt[1], &dattrv[1], 
