/* dsics.f -- translated by f2c (version 12.02.01).
...
/* DECK DSICS */
/* Subroutine */ int dsics_(integer *n, integer *nelt, integer *ia, integer *
	ja, doublereal *a, integer *isym, integer *nel, integer *iel, integer 
	*jel, doublereal *el, doublereal *d__, doublereal *r__, integer *
	iwarn)
{
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "DSICS", ch__1, &c__1, &c__2, (ftnlen)6, (
		    ftnlen)5, (ftnlen)48);
L100:
	    ;
	}
