/* dsllti.f -- translated by f2c (version 12.02.01).
...
/* DECK DSLLTI */
/* Subroutine */ int dsllti_(integer *n, doublereal *b, doublereal *x, 
	integer *nelt, integer *ia, integer *ja, doublereal *a, integer *isym,
	 doublereal *rwork, integer *iwork)
{
    static integer nel, locel;
    extern /* Subroutine */ int dllti2_(integer *, doublereal *, doublereal *,
...
/* ***FIRST EXECUTABLE STATEMENT  DSLLTI */
    ...
    locel = iwork[4];
    locdin = iwork[5];
    dllti2_(n, &b[1], &x[1], &nel, &iwork[lociel], &iwork[locjel], &rwork[
	    locel], &rwork[locdin]);
