/* sdntp.f -- translated by f2c (version 12.02.01).
...
/* DECK SDNTP */
/* Subroutine */ int sdntp_(real *h__, integer *k, integer *n, integer *nq, 
	real *t, real *tout, real *yh, real *y)
{
