/* bndsol.f -- translated by f2c (version 12.02.01).
...
/* DECK BNDSOL */
/* Subroutine */ int bndsol_(integer *mode, real *g, integer *mdg, integer *
	nb, integer *ip, integer *ir, real *x, integer *n, real *rnorm)
{
...
L130:
    nerr = 1;
    iopt = 2;
    xermsg_("SLATEC", "BNDSOL", "A ZERO DIAGONAL TERM IS IN THE N BY N UPPER"
