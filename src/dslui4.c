/* dslui4.f -- translated by f2c (version 12.02.01).
...
/* DECK DSLUI4 */
/* Subroutine */ int dslui4_(integer *n, doublereal *b, doublereal *x, 
	integer *il, integer *jl, doublereal *l, doublereal *dinv, integer *
	iu, integer *ju, doublereal *u)
{
