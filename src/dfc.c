/* dfc.f -- translated by f2c (version 12.02.01).
...
/* DECK DFC */
/* Subroutine */ int dfc_(integer *ndata, doublereal *xdata, doublereal *
	ydata, doublereal *sddata, integer *nord, integer *nbkpt, doublereal *
	bkpt, integer *nconst, doublereal *xconst, doublereal *yconst, 
	integer *nderiv, integer *mode, doublereal *coeff, doublereal *w, 
	integer *iw)
{
    static integer i1, i2, i3, i4, i5, i6, i7, mdg, mdw;
    extern /* Subroutine */ int dfcmn_(integer *, doublereal *, doublereal *, 
...
/*     I7,...           WORK(*) FOR DLSEI( ) */
    ...
    dfcmn_(ndata, &xdata[1], &ydata[1], &sddata[1], nord, nbkpt, &bkpt[1], 
	    nconst, &xconst[1], &yconst[1], &nderiv[1], mode, &coeff[1], &w[
	    i5], &w[i2], &w[i3], &w[i4], &w[i1], &mdg, &w[i6], &mdw, &w[i7], &
	    iw[1]);
    return 0;
} /* dfc_ */
