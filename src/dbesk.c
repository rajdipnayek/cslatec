/* dbesk.f -- translated by f2c (version 12.02.01).
...
/* DECK DBESK */
/* Subroutine */ int dbesk_(doublereal *x, doublereal *fnu, integer *kode, 
	integer *n, doublereal *y, integer *nz)
{
    ...
    static doublereal s, t, w[2], s1, s2;
    static integer nb;
    ...
    static integer mz;
    static doublereal zn, gln, fnn;
    static integer nud;
    static doublereal dnu, gnu, etx, trx, rtz, elim, xlim, flgik;
    extern doublereal d1mach_(integer *);
    extern integer i1mach_(integer *);
    extern doublereal dbesk0_(doublereal *), dbesk1_(doublereal *), dbsk1e_(
	    doublereal *), dbsk0e_(doublereal *);
    extern /* Subroutine */ int dasyik_(doublereal *, doublereal *, integer *,
	     doublereal *, doublereal *, doublereal *, integer *, doublereal *
	    ), dbsknu_(doublereal *, doublereal *, integer *, integer *, 
...
/* ***FIRST EXECUTABLE STATEMENT  DBESK */
    nn = -i1mach_(&c__15);
    elim = (nn * d1mach_(&c__5) - 3.) * 2.303;
    xlim = d1mach_(&c__1) * 1e3;
    if (*kode < 1 || *kode > 2) {
	goto L280;
    }
    if (*fnu < 0.) {
