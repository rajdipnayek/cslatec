/* sbols.f -- translated by f2c (version 12.02.01).
...
/* DECK SBOLS */
/* Subroutine */ int sbols_(real *w, integer *mdw, integer *mrows, integer *
	ncols, real *bl, real *bu, integer *ind, integer *iopt, real *x, real 
	*rnorm, integer *mode, real *rw, integer *iw)
{
    /* Initialized data */
    ...
    char ch__1[32], ch__2[55], ch__3[37], ch__4[77], ch__5[36], ch__6[82], 
	    ...
	    75], ch__13[64], ch__14[72], ch__15[63];
    ...
    static integer llb;
    static real one;
    static integer lds, llx, ibig, lmdw, lndw, nerr, lenx, lliw, mnew, lopt;
    static real zero;
    static integer llrw;
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    integer *), srotg_(real *, real *, real *, real *);
    static integer locacc;
    static logical checkl;
    static integer iscale, locdim;
    extern integer isamax_(integer *, real *, integer *);
    extern /* Subroutine */ int sbolsm_(real *, integer *, integer *, integer 
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOLS", ch__1, &c__2, &c__1, (ftnlen)6, (
		    ftnlen)5, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOLS", ch__2, &c__3, &c__1, (ftnlen)6, (
		    ftnlen)5, (ftnlen)55);
/*     DO(RETURN TO USER PROGRAM UNIT) */
	    goto L190;
	}
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOLS", ch__3, &c__4, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)37);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L190;
	    }
...
/* Writing concatenation */
		    ...
		    xermsg_("SLATEC", "SBOLS", ch__4, &c__5, &c__1, (ftnlen)6,
			     (ftnlen)5, (ftnlen)77);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		    goto L190;
		}
...
/* Writing concatenation */
		    ...
		    xermsg_("SLATEC", "SBOLS", ch__5, &c__7, &c__1, (ftnlen)6,
			     (ftnlen)5, (ftnlen)36);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		    goto L190;
		}
...
/* Writing concatenation */
		    ...
		    xermsg_("SLATEC", "SBOLS", ch__6, &c__8, &c__1, (ftnlen)6,
			     (ftnlen)5, (ftnlen)82);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		    goto L190;
		}
...
/* Writing concatenation */
			...
			xermsg_("SLATEC", "SBOLS", ch__7, &c__9, &c__1, (
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOLS", ch__8, &c__6, &c__1, (ftnlen)6, (
		    ftnlen)5, (ftnlen)44);
/*     DO(RETURN TO USER PROGRAM UNIT) */
	    goto L190;
	}
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOLS", ch__9, &c__11, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)79);
		goto L190;
	    }
	    if (lndw < *ncols + 1) {
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOLS", ch__10, &c__12, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)71);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L190;
	    }
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOLS", ch__11, &c__13, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)91);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L190;
	    }
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOLS", ch__12, &c__14, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)75);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L190;
	    }
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOLS", ch__13, &c__15, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)64);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L190;
	    }
...
/* Writing concatenation */
		...
		i__5[3] = 8, a__4[3] = xern2;
		s_cat(ch__13, a__4, i__5, &c__4, (ftnlen)64);
		xermsg_("SLATEC", "SBOLS", ch__13, &c__16, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)64);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L190;
	    }
...
/* Writing concatenation */
		...
		i__5[3] = 8, a__4[3] = xern2;
		s_cat(ch__14, a__4, i__5, &c__4, (ftnlen)72);
		xermsg_("SLATEC", "SBOLS", ch__14, &c__17, &c__1, (ftnlen)6, (
			ftnlen)5, (ftnlen)72);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L190;
	    }
...
/* Writing concatenation */
	...
	i__5[3] = 8, a__4[3] = xern2;
	s_cat(ch__15, a__4, i__5, &c__4, (ftnlen)63);
	xermsg_("SLATEC", "SBOLS", ch__15, &c__10, &c__1, (ftnlen)6, (ftnlen)
		5, (ftnlen)63);
/*     DO(RETURN TO USER PROGRAM UNIT) */
	goto L190;
    }
/* Computing MIN */
	...
	for (i__ = mnew; i__ >= i__6; --i__) {
	    i__7 = i__ - j;
	    ibig = isamax_(&i__7, &w[j + j * w_dim1], &c__1) + j - 1;

/*     PIVOT FOR INCREASED STABILITY. */
	    srotg_(&w[ibig + j * w_dim1], &w[i__ + j * w_dim1], &sc, &ss);
	    i__7 = *ncols + 1 - j;
	    srot_(&i__7, &w[ibig + (j + 1) * w_dim1], mdw, &w[i__ + (j + 1) * 
		    w_dim1], mdw, &sc, &ss);
	    w[i__ + j * w_dim1] = zero;
/* L70: */
	}
...
/*     COL. HAS MAX. NORM EQUAL TO ONE. */
	ibig = isamax_(mrows, &w[j * w_dim1 + 1], &c__1);
	rw[j] = (r__1 = w[ibig + j * w_dim1], dabs(r__1));
	if (rw[j] == zero) {
	    rw[j] = one;
	} else {
	    rw[j] = one / rw[j];
...
/*     HAVE EUCLIDEAN LENGTH EQUAL TO ONE. */
	rw[j] = snrm2_(mrows, &w[j * w_dim1 + 1], &c__1);
	if (rw[j] == zero) {
	    rw[j] = one;
	} else {
	    rw[j] = one / rw[j];
...
/*     THE SCALING MATRIX TO THE IDENTITY MATRIX. */
	rw[1] = one;
	scopy_(ncols, &rw[1], &c__0, &rw[1], &c__1);
	goto L160;
L130:
/*     CASE 4 */
	goto L160;
...
/* L170: */
    ...
    sbolsm_(&w[w_offset], mdw, mrows, ncols, &rw[*ncols * 3 + 1], &rw[(*ncols 
