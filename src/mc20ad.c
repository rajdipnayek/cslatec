/* mc20ad.f -- translated by f2c (version 12.02.01).
...
/* DECK MC20AD */
/* Subroutine */ int mc20ad_(integer *nc, integer *maxa, doublereal *a, 
	integer *inum, integer *jptr, integer *jnum, integer *jdisp)
{
