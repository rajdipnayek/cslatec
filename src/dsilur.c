/* dsilur.f -- translated by f2c (version 12.02.01).
...
/* DECK DSILUR */
/* Subroutine */ int dsilur_(integer *n, doublereal *b, doublereal *x, 
...
/*         Check the workspace allocations. */
    dchkw_("DSILUR", &lociw, leniw, &locw, lenw, ierr, iter, err, (ftnlen)6);
    if (*ierr != 0) {
	return 0;
    }
