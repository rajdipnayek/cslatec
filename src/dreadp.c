/* dreadp.f -- translated by f2c (version 12.02.01).
...
/* DECK DREADP */
/* Subroutine */ int dreadp_(integer *ipage, integer *list, doublereal *rlist,
...
/* ***FIRST EXECUTABLE STATEMENT  DREADP */
    ...
    i__2 = lpg;
    for (i__ = 1; i__ <= i__2; ++i__) {
	i__1 = do_uio(&c__1, (char *)&rlist[i__], (ftnlen)sizeof(doublereal));
	if (i__1 != 0) {
	    goto L100;
	}
    }
...
/* Writing concatenation */
    i__3[0] = 16, a__1[0] = "IN DSPLP, LPG = ";
    i__3[1] = 8, a__1[1] = xern1;
    i__3[2] = 9, a__1[2] = " IRECN = ";
    i__3[3] = 8, a__1[3] = xern2;
    s_cat(ch__1, a__1, i__3, &c__4, (ftnlen)41);
    xermsg_("SLATEC", "DREADP", ch__1, &c__100, &c__1, (ftnlen)6, (ftnlen)6, (
	    ftnlen)41);
    return 0;
} /* dreadp_ */
