/* dsds.f -- translated by f2c (version 12.02.01).
...
/* DECK DSDS */
/* Subroutine */ int dsds_(integer *n, integer *nelt, integer *ia, integer *
	ja, doublereal *a, integer *isym, doublereal *dinv)
{
