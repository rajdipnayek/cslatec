/* spofs.f -- translated by f2c (version 12.02.01).
...
/* DECK SPOFS */
/* Subroutine */ int spofs_(real *a, integer *lda, integer *n, real *v, 
	integer *itask, integer *ind, real *work)
{
    ...
    static real rcond;
    extern /* Subroutine */ int spoco_(real *, integer *, integer *, real *, 
	    real *, integer *), sposl_(real *, integer *, integer *, real *);
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SPOFS", ch__1, &c_n1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)40);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SPOFS", ch__2, &c_n2, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)27);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SPOFS", ch__3, &c_n3, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)31);
	return 0;
    }
...
/*        FACTOR MATRIX A INTO R */
	...
	spoco_(&a[a_offset], lda, n, &rcond, &work[1], &info);

/*        CHECK FOR POSITIVE DEFINITE MATRIX */

	if (info != 0) {
	    *ind = -4;
	    xermsg_("SLATEC", "SPOFS", "SINGULAR OR NOT POSITIVE DEFINITE - "
...
/*        AND CHECK FOR IND GREATER THAN ZERO */
	...
	*ind = -r_lg10(&r__1);
	if (*ind <= 0) {
	    *ind = -10;
	    xermsg_("SLATEC", "SPOFS", "SOLUTION MAY HAVE NO SIGNIFICANCE", &
