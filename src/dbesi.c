/* dbesi.f -- translated by f2c (version 12.02.01).
...
/* DECK DBESI */
/* Subroutine */ int dbesi_(doublereal *x, doublereal *alpha, integer *kode, 
	integer *n, doublereal *y, integer *nz)
{
    /* Initialized data */

    static doublereal rttpi = .398942280401433;
    ...
    static doublereal s, t, z__;
    static integer i1;
    static doublereal s1, s2, t2, ak, ap, ra, fn, ta;
    static integer kk, in, km;
    static doublereal tb;
    static integer is, nn;
    static doublereal dx;
    static integer kt, ns;
    static doublereal tm, sx, xo2, ain, akm, arg, dfn, fnf, fni, gln, ans, 
	    dtm, tfn, fnu, tol, etx, trx, fnp1, xo2l, sxo2, earg;
    static integer ialp;
    static doublereal elim, atol, temp[3], flgik, tolln;
