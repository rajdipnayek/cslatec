/* dpolvl.f -- translated by f2c (version 12.02.01).
...
/* DECK DPOLVL */
/* Subroutine */ int dpolvl_(integer *nder, doublereal *xx, doublereal *yfit, 
	doublereal *yp, integer *n, doublereal *x, doublereal *c__, 
	doublereal *work, integer *ierr)
{
    ...
    static integer km1pi, nmkp1, km2pn, npkm1;
    static doublereal pione;
    static integer izero;
    static doublereal pitwo;
