/* cuoik.f -- translated by f2c (version 12.02.01).
	...
	real *alim)
{
    ...
    static real aic = 1.265512123484645396f;
...
L20:
    ...
    q__1.r = q__2.r * 0.f - q__2.i * 1.f, q__1.i = q__2.r * 1.f + q__2.i * 
	    0.f;
...
L80:
    ...
    c_log(&q__4, &arg);
    q__3.r = q__4.r * .25f - q__4.i * 0.f, q__3.i = q__4.r * 0.f + q__4.i * 
	    .25f;
    q__2.r = cz.r - q__3.r, q__2.i = cz.i - q__3.i;
    q__5.r = aic, q__5.i = 0.f;
    q__1.r = q__2.r - q__5.r, q__1.i = q__2.i - q__5.i;
    cz.r = q__1.r, cz.i = q__1.i;
L90:
    ax = exp(rcz) / *tol;
    ay = r_imag(&cz);
    q__2.r = ax, q__2.i = 0.f;
    r__1 = cos(ay);
    r__2 = sin(ay);
