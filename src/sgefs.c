/* sgefs.f -- translated by f2c (version 12.02.01).
...
/* DECK SGEFS */
/* Subroutine */ int sgefs_(real *a, integer *lda, integer *n, real *v, 
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SGEFS", ch__1, &c_n1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)40);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SGEFS", ch__2, &c_n2, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)27);
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SGEFS", ch__3, &c_n3, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)31);
	return 0;
    }
...
/*        FACTOR MATRIX A INTO LU */
	...
	sgeco_(&a[a_offset], lda, n, &iwork[1], &rcond, &work[1]);

/*        CHECK FOR COMPUTATIONALLY SINGULAR MATRIX */

	if (rcond == 0.f) {
	    *ind = -4;
	    xermsg_("SLATEC", "SGEFS", "SINGULAR MATRIX A - NO SOLUTION", &
...
/*        AND CHECK FOR IND GREATER THAN ZERO */
	...
	*ind = -r_lg10(&r__1);
	if (*ind <= 0) {
	    *ind = -10;
	    xermsg_("SLATEC", "SGEFS", "SOLUTION MAY HAVE NO SIGNIFICANCE", &
...
/*     SOLVE AFTER FACTORING */
    ...
    sgesl_(&a[a_offset], lda, n, &iwork[1], &v[1], &c__0);
    return 0;
} /* sgefs_ */
