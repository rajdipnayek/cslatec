/* compb.f -- translated by f2c (version 12.02.01).
...
/* DECK COMPB */
/* Subroutine */ int compb_(integer *n, integer *ierror, real *an, real *bn, 
	real *cn, real *b, real *ah, real *bh)
{
    ...
    extern /* Subroutine */ int ppadd_(integer *, integer *, real *, real *, 
	    real *, real *, real *), indxb_(integer *, integer *, integer *, 
	    integer *);
    static real bnorm;
    extern /* Subroutine */ int tevls_(integer *, real *, real *, integer *);
...
L113:
    i__1 = cblkt_1.k - 1;
    indxb_(&if__, &i__1, &j2, &lh);
    i__1 = if__ / 2;
    i__3 = cblkt_1.k - 1;
    indxb_(&i__1, &i__3, &j1, &lh);
    ++j2;
    lh = j2;
    n2m2 = j2 + cblkt_1.nm + cblkt_1.nm - 2;
L114:
...
L116:
    b[lh] = b[n2m2 + 1];
    i__1 = cblkt_1.k - 1;
    indxb_(&if__, &i__1, &j1, &j2);
    j2 = j1 + nmp + nmp;
    i__1 = cblkt_1.nm + 1;
    ppadd_(&i__1, ierror, &an[1], &cn[1], &b[j1], &b[j1], &b[j2]);
L117:
    return 0;
L118:
    *ierror = 4;
