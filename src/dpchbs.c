/* dpchbs.f -- translated by f2c (version 12.02.01).
...
/* DECK DPCHBS */
/* Subroutine */ int dpchbs_(integer *n, doublereal *x, doublereal *f, 
	...
	integer *ierr)
{
    ...
    static char libnam[8];
    extern /* Subroutine */ int dpchkt_(integer *, doublereal *, integer *, 
	    doublereal *);
...
/*  Initialize. */
    ...
    *ierr = 0;
    ...
    s_copy(subnam, "DPCHBS", (ftnlen)8, (ftnlen)6);
