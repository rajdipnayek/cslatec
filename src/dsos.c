/* dsos.f -- translated by f2c (version 12.02.01).
...
/* DECK DSOS */
/* Subroutine */ int dsos_(D_fp fnc, integer *neq, doublereal *x, doublereal *
	rtolx, doublereal *atolx, doublereal *tolf, integer *iflag, 
	doublereal *rw, integer *lrw, integer *iw, integer *liw)
{
    /* System generated locals */
    address a__1[2], a__2[4];
    integer i__1[2], i__2[4];
    char ch__1[97], ch__2[151], ch__3[105], ch__4[176], ch__5[116], ch__6[98];

    /* Local variables */
    static integer k1, k2, k3, k4, k5, k6, nc, ncjs, nsri, mxit;
    static char xern1[8], xern3[16], xern4[16];
    static integer nsrrc, inpflg;
    extern /* Subroutine */ int dsoseq_(D_fp, integer *, doublereal *, 
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DSOS", ch__1, &c__1, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)97);
	*iflag = 9;
    }
    ...
    if (*rtolx < 0. || *atolx < 0.) {
	s_wsfi(&io___5);
	do_fio(&c__1, (char *)&(*atolx), (ftnlen)sizeof(doublereal));
	e_wsfi();
	s_wsfi(&io___7);
	do_fio(&c__1, (char *)&(*rtolx), (ftnlen)sizeof(doublereal));
	e_wsfi();
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DSOS", ch__2, &c__2, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)151);
	*iflag = 9;
    }
    ...
    if (*tolf < 0.) {
	s_wsfi(&io___8);
	do_fio(&c__1, (char *)&(*tolf), (ftnlen)sizeof(doublereal));
	e_wsfi();
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DSOS", ch__3, &c__3, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)105);
	*iflag = 9;
    }
	...
	if (mxit <= 0) {
	    ...
	    e_wsfi();
/* Writing concatenation */
	    i__1[0] = 168, a__1[0] = "YOU HAVE TOLD THE CODE TO USE OPTIONAL"
		    " INPUT ITEMS BY SETTING IFLAG=-1. HOWEVER YOU HAVE CALLE"
		    "D THE CODE WITH THE MAXIMUM ALLOWABLE NUMBER OF ITERATIO"
		    "NS SET TO IW(2) = ";
	    i__1[1] = 8, a__1[1] = xern1;
	    s_cat(ch__4, a__1, i__1, &c__2, (ftnlen)176);
	    xermsg_("SLATEC", "DSOS", ch__4, &c__4, &c__1, (ftnlen)6, (ftnlen)
		    4, (ftnlen)176);
	    *iflag = 9;
	}
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DSOS", ch__5, &c__5, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)116);
	*iflag = 9;
    }
	...
	e_wsfi();
/* Writing concatenation */
	i__1[0] = 90, a__1[0] = "DIMENSION OF THE IW ARRAY MUST BE AT LEAST "
		"3 + NEQ.  YOU HAVE CALLED THE CODE WITH  LIW = ";
	i__1[1] = 8, a__1[1] = xern1;
	s_cat(ch__6, a__1, i__1, &c__2, (ftnlen)98);
	xermsg_("SLATEC", "DSOS", ch__6, &c__6, &c__1, (ftnlen)6, (ftnlen)4, (
		ftnlen)98);
	*iflag = 9;
    }
	...
	dsoseq_((D_fp)fnc, neq, &x[1], rtolx, atolx, tolf, iflag, &mxit, &
