/* dpnnzr.f -- translated by f2c (version 12.02.01).
...
/* DECK DPNNZR */
/* Subroutine */ int dpnnzr_(integer *i__, doublereal *xval, integer *iplace, 
...
/*     CHECK VALIDITY OF ROW/COL. INDEX. */
    ...
    nerr = 55;
    xermsg_("SLATEC", "DPNNZR", "IRCX=0", &nerr, &iopt, (ftnlen)6, (ftnlen)6, 
	    (ftnlen)6);
...
/*     THE INDEX MUST BE .LE. N. */
    ...
    nerr = 55;
    xermsg_("SLATEC", "DPNNZR", "SUBSCRIPTS FOR ARRAY ELEMENT TO BE ACCESSED"
