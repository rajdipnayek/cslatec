/* dsteps.f -- translated by f2c (version 12.02.01).
	...
	kgi, doublereal *gi, doublereal *rpar, integer *ipar)
{
    ...
    static doublereal r__, u;
    static integer iq, jv, im1, km1, ip1, km2, kp1, kp2;
    static doublereal big, erk, err, rho, tau;
    static integer nsm2, nsp1, nsp2;
    static doublereal absh, hnew;
    static integer knew;
    static doublereal erkm1, erkm2, erkp1, temp1, temp2, temp3, temp4, temp5, 
	    temp6, p5eps;
