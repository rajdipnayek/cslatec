/* sdzro.f -- translated by f2c (version 12.02.01).
...
/* DECK SDZRO */
/* Subroutine */ int sdzro_(real *ae, E_fp f, real *h__, integer *n, integer *
	nq, integer *iroot, real *re, real *t, real *yh, real *uround, real *
	b, real *c__, real *fb, real *fc, real *y)
{
...
/*                                             for new iterate B. */
L20:
    sdntp_(h__, &c__0, n, nq, t, b, &yh[yh_offset], &y[1]);
    *fb = (*f)(n, b, &y[1], iroot);
    if (*n == 0) {
	return 0;
    }
