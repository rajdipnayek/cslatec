/* dasyjy.f -- translated by f2c (version 12.02.01).
...
/* DECK DASYJY */
/* Subroutine */ int dasyjy_(S_fp funjy, doublereal *x, doublereal *fnu, 
	doublereal *flgjy, integer *in, doublereal *y, doublereal *wk, 
	integer *iflw)
{
    /* Initialized data */

    static doublereal con2 = .333333333333333;
    static doublereal con548 = .104166666666667;
    static doublereal ar[8] = { .0835503472222222,.128226574556327,
	    .29184902646414,.881627267443758,3.32140828186277,
	    14.9957629868626,78.9230130115865,474.451538868264 };
    static doublereal br[10] = { -.145833333333333,-.0987413194444444,
    ...
    static doublereal c__[65] = { -.208333333333333,.125,.334201388888889,
    ...
    static doublereal gama[26] = { .629960524947437,.251984209978975,
    ...
    static doublereal tols = -6.90775527898214;
    static doublereal con1 = .666666666666667;
    static struct {
	doublereal e_1[104];
    ...
    static doublereal z__, s1, t2;
    static integer kb;
    static doublereal fi, ap, cr[10], dr[10];
    static integer jn;
    static doublereal fn, sa, az;
    static integer jr;
    static doublereal sb;
    static integer ks, ju, lr;
    static doublereal ta, tb, z32, xx, fn2;
    static integer kp1;
    static doublereal dfi, akm, phi, tfn, tau, rcz, tol, rtz, abw2, rfn2;
    static integer ksp1, lrp1;
#define alfa ((doublereal *)&equiv_1)
#define beta ((doublereal *)&equiv_4)
    static doublereal relb, elim, rden;
    static integer kmax[5];
    static doublereal crz32, asum, bsum, suma, sumb, upol[10];
#define alfa1 ((doublereal *)&equiv_1)
#define alfa2 ((doublereal *)&equiv_1 + 52)
#define beta1 ((doublereal *)&equiv_4)
#define beta2 ((doublereal *)&equiv_4 + 52)
#define beta3 ((doublereal *)&equiv_4 + 104)
    static integer iseta, isetb, klast;
    static doublereal rzden;
