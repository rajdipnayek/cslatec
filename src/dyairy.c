/* dyairy.f -- translated by f2c (version 12.02.01).
...
/* DECK DYAIRY */
/* Subroutine */ int dyairy_(doublereal *x, doublereal *rx, doublereal *c__, 
	doublereal *bi, doublereal *dbi)
{
    /* Initialized data */
    ...
    static doublereal fpi12 = 1.30899693899575;
    static doublereal spi12 = 1.83259571459405;
    static doublereal con1 = .666666666666667;
    static doublereal con2 = 7.74148278841779;
    static doublereal con3 = .364766105490356;
    static integer n2 = 19;
    static doublereal bk1[20] = { 2.43202846447449,2.57132009754685,
    ...
    static doublereal bk2[20] = { .574830555784088,-.00691648648376891,
    ...
    static doublereal bk3[20] = { .566777053506912,.00263672828349579,
    ...
    static doublereal bk4[14] = { .485444386705114,-.00308525088408463,
	    ...
	    ;
    static doublereal bjp[19] = { .134918611457638,-.319314588205813,
    ...
    static doublereal bjn[19] = { .0659041673525697,-.424905910566004,
    ...
    static doublereal aa[14] = { -.278593552803079,.00352915691882584,
    ...
    static doublereal bb[14] = { -.490275424742791,-.00157647277946204,
    ...
    static doublereal dbk1[21] = { 2.95926143981893,3.86774568440103,
    ...
    static doublereal dbk2[20] = { .549756809432471,.00913556983276901,
    ...
    static doublereal dbk3[20] = { .560598509354302,-.00364870013248135,
	    ...
	    ;
    static doublereal dbk4[14] = { .493072999188036,.00438335419803815,
    ...
    static doublereal dbjp[19] = { .113140872390745,-.208301511416328,
    ...
    static doublereal dbjn[19] = { -.018809126006885,-.14779818082614,
    ...
    static doublereal daa[14] = { .277571356944231,-.0044421283341992,
    ...
    static doublereal dbb[14] = { .491627321104601,.00311164930427489,
    ...
    static doublereal t, d1, d2, e1, e2, f1, f2, s1, s2, tc, ax, cv, ex, tt, 
	    rtrx, temp1, temp2;
