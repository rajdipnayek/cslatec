/* dcg.f -- translated by f2c (version 12.02.01).
...
/* DECK DCG */
/* Subroutine */ int dcg_(integer *n, doublereal *b, doublereal *x, integer *
	...
	doublereal *r__, doublereal *z__, doublereal *p, doublereal *dz, 
	doublereal *rwork, integer *iwork)
{
    ...
    extern doublereal ddot_(integer *, doublereal *, integer *, doublereal *, 
	    integer *);
    static doublereal bnrm, akden, bkden;
    extern integer isdcg_(integer *, doublereal *, doublereal *, integer *, 
	    integer *, integer *, doublereal *, integer *, S_fp, integer *, 
	    doublereal *, integer *, integer *, doublereal *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     doublereal *, integer *, doublereal *, doublereal *, doublereal *
	    , doublereal *);
    static doublereal bknum;
...
/* L10: */
    ...
    if (isdcg_(n, &b[1], &x[1], nelt, &ia[1], &ja[1], &a[1], isym, (S_fp)
...
/*         and new pseudo-residual z. */
	...
	akden = ddot_(n, &p[1], &c__1, &z__[1], &c__1);
	if (akden <= 0.) {
	    *ierr = 6;
	    return 0;
	}
