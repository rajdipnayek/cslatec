/* rsgba.f -- translated by f2c (version 12.02.01).
...
/* DECK RSGBA */
/* Subroutine */ int rsgba_(integer *nm, integer *n, real *a, real *b, real *
	w, integer *matz, real *z__, real *fv1, real *fv2, integer *ierr)
{
    ...
    extern /* Subroutine */ int tql2_(integer *, integer *, real *, real *, 
	    ...
	    real *, real *), reduc2_(integer *, integer *, real *, real *, 
	    real *, integer *), rebakb_(integer *, integer *, real *, real *, 
