/* dbesj.f -- translated by f2c (version 12.02.01).
...
/* DECK DBESJ */
/* Subroutine */ int dbesj_(doublereal *x, doublereal *alpha, integer *n, 
	doublereal *y, integer *nz)
{
    /* Initialized data */

    static doublereal rtwo = 1.34839972492648;
    static doublereal pdf = .785398163397448;
    static doublereal rttp = .797884560802865;
    static doublereal pidt = 1.5707963267949;
    static doublereal pp[4] = { 8.72909153935547,.26569393226503,
	    .124578576865586,7.70133747430388e-4 };
    static integer inlim = 150;
    static doublereal fnulim[2] = { 100.,60. };
    ...
    static doublereal s1, s2, t1, t2, ak, ap, fn, sa;
    static integer kk, in, km;
    static doublereal sb, ta, tb;
    static integer is, nn, kt, ns;
    static doublereal tm, wk[7], tx, xo2, dfn, akm, arg, fnf, fni, gln, ans, 
	    dtm, tfn, fnu, tau, tol, etx, rtx, trx, fnp1, xo2l, sxo2, coef, 
	    earg, relb;
    static integer ialp;
    static doublereal rden;
    static integer iflw;
    static doublereal slim, temp[3], rtol, elim1, fidal;
    static integer idalp;
    static doublereal flgjy, rzden, tolln;
    extern doublereal d1mach_(integer *);
    extern integer i1mach_(integer *);
    static doublereal dalpha;
    extern doublereal dlngam_(doublereal *);
    extern /* Subroutine */ int djairy_();
    extern /* Subroutine */ int dasyjy_(U_fp, doublereal *, doublereal *, 
...
L130:
    ...
    i1 = max(i1,1);
    flgjy = 1.;
    dasyjy_((U_fp)djairy_, x, &fn, &flgjy, &i1, &temp[is - 1], wk, &iflw);
    if (iflw != 0) {
	goto L380;
    }
    switch (is) {
