/* dsdcgs.f -- translated by f2c (version 12.02.01).
...
/* DECK DSDCGS */
/* Subroutine */ int dsdcgs_(integer *n, doublereal *b, doublereal *x, 
	...
	integer *lenw, integer *iwork, integer *leniw)
{
    extern /* Subroutine */ int ds2y_(integer *, integer *, integer *, 
	    integer *, doublereal *, integer *), dcgs_(integer *, doublereal *
	    , doublereal *, integer *, integer *, integer *, doublereal *, 
	    integer *, U_fp, U_fp, integer *, doublereal *, integer *, 
    ...
    static integer locr0, locv1, locv2;
...
/*         Check the workspace allocations. */
    dchkw_("DSDCGS", &lociw, leniw, &locw, lenw, ierr, iter, err, (ftnlen)6);
    if (*ierr != 0) {
	return 0;
    }
