/* qs2i1d.f -- translated by f2c (version 12.02.01).
...
/* DECK QS2I1D */
/* Subroutine */ int qs2i1d_(integer *ia, integer *ja, doublereal *a, integer 
	*n, integer *kflag)
{
...
/* ***FIRST EXECUTABLE STATEMENT  QS2I1D */
    ...
    nn = *n;
    if (nn < 1) {
	xermsg_("SLATEC", "QS2I1D", "The number of values to be sorted was n"
    ...
    kk = abs(*kflag);
    if (kk != 1) {
	xermsg_("SLATEC", "QS2I1D", "The sort control parameter, K, was not "
