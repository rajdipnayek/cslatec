/* dchkw.f -- translated by f2c (version 12.02.01).
...
/* DECK DCHKW */
/* Subroutine */ int dchkw_(char *name__, integer *lociw, integer *leniw, 
	integer *locw, integer *lenw, integer *ierr, integer *iter, 
	doublereal *err, ftnlen name_len)
{
    /* System generated locals */
    address a__1[7];
    integer i__1[7];
    char ch__1[89], ch__2[98];
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "DCHKW", ch__1, &c__1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)89);
    }
...
/* Writing concatenation */
	i__1[0] = 3, a__1[0] = "In ";
	i__1[1] = 8, a__1[1] = xernam;
	i__1[2] = 34, a__1[2] = ", DOUBLE PRECISION work array too ";
	i__1[3] = 20, a__1[3] = "short.  RWORK needs ";
	i__1[4] = 8, a__1[4] = xern1;
	i__1[5] = 17, a__1[5] = "; have allocated ";
	i__1[6] = 8, a__1[6] = xern2;
	s_cat(ch__2, a__1, i__1, &c__7, (ftnlen)98);
	xermsg_("SLATEC", "DCHKW", ch__2, &c__1, &c__1, (ftnlen)6, (ftnlen)5, 
		(ftnlen)98);
    }
    return 0;
