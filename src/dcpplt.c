/* dcpplt.f -- translated by f2c (version 12.02.01).
...
/* DECK DCPPLT */
/* Subroutine */ int dcpplt_(integer *n, integer *nelt, integer *ia, integer *
	ja, doublereal *a, integer *isym, integer *iunit)
{
    /* Format strings */
    static char fmt_1000[] = "(/\002**** Picture of Column SLAP matrix follo"
	    "ws ****\002/\002 N, NELT and Density = \002,2i10,d16.7)";
