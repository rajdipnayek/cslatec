/* sdriv2.f -- translated by f2c (version 12.02.01).
...
/* DECK SDRIV2 */
/* Subroutine */ int sdriv2_(integer *n, real *t, real *y, U_fp f, real *tout,
	 integer *mstate, integer *nroot, real *eps, real *ewt, integer *mint,
	 real *work, integer *lenw, integer *iwork, integer *leniw, E_fp g, 
	integer *ierflg)
{
...
/* ***FIRST EXECUTABLE STATEMENT  SDRIV2 */
    ...
    if (abs(*mstate) == 9) {
	*ierflg = 999;
	xermsg_("SLATEC", "SDRIV2", "Illegal input.  The magnitude of MSTATE"
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV2", ch__1, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)78);
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV2", ch__2, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)74);
	*mstate = i_sign(&c__9, mstate);
	return 0;
    }
    ...
    sdriv3_(n, t, &y[1], (U_fp)f, &nstate, tout, &ntask, nroot, eps, ewtcom, &
