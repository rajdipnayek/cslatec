/* dpchsp.f -- translated by f2c (version 12.02.01).
...
/* DECK DPCHSP */
/* Subroutine */ int dpchsp_(integer *ic, doublereal *vc, integer *n, 
...
/*                 -------------------------------- */
	d__[d_dim1 + 1] = dpchdf_(&ibeg, xtemp, stemp, ierr);
/*                 -------------------------------- */
	if (*ierr != 0) {
	    goto L5009;
	}
...
/*                 -------------------------------- */
	d__[*n * d_dim1 + 1] = dpchdf_(&iend, xtemp, stemp, ierr);
/*                 -------------------------------- */
	if (*ierr != 0) {
	    goto L5009;
	}
