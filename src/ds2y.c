/* ds2y.f -- translated by f2c (version 12.02.01).
...
/* DECK DS2Y */
/* Subroutine */ int ds2y_(integer *n, integer *nelt, integer *ia, integer *
	ja, doublereal *a, integer *isym)
{
    ...
    extern /* Subroutine */ int qs2i1d_(integer *, integer *, doublereal *, 
	    integer *, integer *);
...
/*         This will line up the columns. */
    ...
    qs2i1d_(&ja[1], &ia[1], &a[1], nelt, &c__1);
