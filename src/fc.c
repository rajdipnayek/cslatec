/* fc.f -- translated by f2c (version 12.02.01).
...
/* DECK FC */
/* Subroutine */ int fc_(integer *ndata, real *xdata, real *ydata, real *
	sddata, integer *nord, integer *nbkpt, real *bkpt, integer *nconst, 
	real *xconst, real *yconst, integer *nderiv, integer *mode, real *
	coeff, real *w, integer *iw)
{
    static integer i1, i2, i3, i4, i5, i6, i7, mdg, mdw;
    extern /* Subroutine */ int fcmn_(integer *, real *, real *, real *, 
...
/*     I7,...           WORK(*) FOR LSEI( ) */
    ...
    fcmn_(ndata, &xdata[1], &ydata[1], &sddata[1], nord, nbkpt, &bkpt[1], 
