/* cbesy.f -- translated by f2c (version 12.02.01).
...
/* DECK CBESY */
/* Subroutine */ int cbesy_(complex *z__, real *fnu, integer *kode, integer *
	n, complex *cy, integer *nz, complex *cwrk, integer *ierr)
{
    ...
    static complex hci;
    static real r1m5, tay, tol, elim, atol, rtol;
    extern /* Subroutine */ int cbesh_(complex *, real *, integer *, integer *
...
L85:
	...
	cy[i__2].r = q__1.r, cy[i__2].i = q__1.i;
	i__2 = i__;
	if (cy[i__2].r == 0.f && cy[i__2].i == 0.f && ey == 0.f) {
	    ++(*nz);
	}
/* L80: */
    }
