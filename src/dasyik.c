/* dasyik.f -- translated by f2c (version 12.02.01).
...
/* DECK DASYIK */
/* Subroutine */ int dasyik_(doublereal *x, doublereal *fnu, integer *kode, 
	doublereal *flgik, doublereal *ra, doublereal *arg, integer *in, 
	doublereal *y)
{
    /* Initialized data */
    ...
    static doublereal t, z__, s1, s2, t2, ak, ap, fn;
    static integer kk, jn;
    static doublereal gln, tol, etx, coef;
