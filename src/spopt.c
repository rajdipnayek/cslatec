/* spopt.f -- translated by f2c (version 12.02.01).
...
/* DECK SPOPT */
/* Subroutine */ int spopt_(real *prgopt, integer *mrelas, integer *nvars__, 
	integer *info, real *csc, integer *ibasis, real *ropt, integer *
	intopt, logical *lopt)
{
...
/*     WORKING WITH UNDEFINED DATA. */
    nerr = 14;
    xermsg_("SLATEC", "SPOPT", "IN SPLP, THE USER OPTION ARRAY HAS UNDEFINED"
	    " DATA.", &nerr, &iopt, (ftnlen)6, (ftnlen)5, (ftnlen)50);
    *info = -nerr;
    return 0;
L20006:
    if (! (next == 1)) {
...
L10001:
    ...
    nerr = 15;
    xermsg_("SLATEC", "SPOPT", "IN SPLP, OPTION ARRAY PROCESSING IS CYCLING.",
...
L20054:
    ...
    csc[j] = (r__1 = prgopt[last + 2 + j], dabs(r__1));
    goto L20053;
L20055:
L20050:
    lds = *nvars__ + 3;
...
/*     PROVIDED. */
    ...
    if (prgopt[last + 2] != zero) {
/* Computing MAX */
	r__1 = eps, r__2 = prgopt[last + 3];
	tolls = dmax(r__1,r__2);
    }
    lds = 4;
    goto L20009;
L20066:
...
/*     THE ERROR IN THE PRIMAL SOLUTION. */
    ...
    if (prgopt[last + 2] != zero) {
/* Computing MAX */
	r__1 = one, r__2 = prgopt[last + 3];
	itbrc = dmax(r__1,r__2);
    }
    lds = 4;
    goto L20009;
L20072:
...
/*     ESTIMATES FOR THE PRIMAL AND DUAL SYSTEMS. */
    ...
    tune = (r__1 = prgopt[last + 3], dabs(r__1));
L20084:
    lds = 4;
    goto L20009;
L20081:
...
L20097:
    ...
    nerr = 16;
    xermsg_("SLATEC", "SPOPT", "IN SPLP, AN INDEX OF USER-SUPPLIED BASIS IS "
	    "OUT OF RANGE.", &nerr, &iopt, (ftnlen)6, (ftnlen)5, (ftnlen)57);
    *info = -nerr;
    return 0;
L20100:
    goto L20096;
...
/*     AND POSITIVE. */
    ...
    nerr = 17;
    xermsg_("SLATEC", "SPOPT", "IN SPLP, SIZE PARAMETERS FOR MATRIX MUST BE "
	    "SMALLEST AND LARGEST MAGNITUDES OF NONZERO ENTRIES.", &nerr, &
	    iopt, (ftnlen)6, (ftnlen)5, (ftnlen)95);
    *info = -nerr;
    return 0;
L20106:
L20103:
...
/*     THE NUMBER OF ITERATIONS OF REV. SIMPLEX STEPS MUST BE POSITIVE. */
    ...
    nerr = 18;
    xermsg_("SLATEC", "SPOPT", "IN SPLP, THE NUMBER OF REVISED SIMPLEX STEPS"
	    " BETWEEN CHECK-POINTS MUST BE POSITIVE.", &nerr, &iopt, (ftnlen)6,
	     (ftnlen)5, (ftnlen)83);
    *info = -nerr;
    return 0;
L20109:
...
/*     CHECK THAT SAVE AND PAGE FILE NUMBERS ARE DEFINED AND NOT EQUAL. */
    ...
    nerr = 19;
    xermsg_("SLATEC", "SPOPT", "IN SPLP, FILE NUMBERS FOR SAVED DATA AND MAT"
	    "RIX PAGES MUST BE POSITIVE AND NOT EQUAL.", &nerr, &iopt, (ftnlen)
	    6, (ftnlen)5, (ftnlen)85);
    *info = -nerr;
    return 0;
L20112:
    goto L20003;
