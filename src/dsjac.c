/* dsjac.f -- translated by f2c (version 12.02.01).
...
/* DECK DSJAC */
/* Subroutine */ int dsjac_(integer *n, doublereal *b, doublereal *x, integer 
...
/*         Check the workspace allocations. */
    dchkw_("DSJAC", &lociw, leniw, &locw, lenw, ierr, iter, err, (ftnlen)5);
    if (*ierr != 0) {
	return 0;
    }
