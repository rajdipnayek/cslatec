/* casyi.f -- translated by f2c (version 12.02.01).
	...
	alim)
{
    ...
    static real rtpi = .159154943091895336f;
...
L10:
    ...
    q__1.r = z__->r * 8.f - z__->i * 0.f, q__1.i = z__->r * 0.f + z__->i * 
	    8.f;
