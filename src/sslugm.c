/* sslugm.f -- translated by f2c (version 12.02.01).
	...
	iwork, integer *leniw)
{
    ...
    static integer locnc, locil, locjl, lociu, lociw, locju, locnr;
...
/*         JPRE = -1, NRMAX = ITMAX/NSAVE */
    ...
    i__1 = *lenw - locrgw;
    sgmres_(n, &b[1], &x[1], nelt, &ia[1], &ja[1], &a[1], isym, (U_fp)ssmv_, (
	    U_fp)sslui_, &myitol, tol, itmax, iter, err, ierr, iunit, &rwork[
