/* ulsia.f -- translated by f2c (version 12.02.01).
...
/* DECK ULSIA */
/* Subroutine */ int ulsia_(real *a, integer *mda, integer *m, integer *n, 
	...
	info)
{
    ...
    static real eps;
    extern /* Subroutine */ int u11us_(real *, integer *, integer *, integer *
	    , real *, real *, integer *, integer *, integer *, integer *, 
	    real *, real *, real *, integer *, integer *), u12us_(real *, 
...
/* L20: */
    ...
    u11us_(&a[a_offset], mda, m, n, &w[m4], &w[m5], mode, np, krank, ksure, &
...
/* L120: */
    ...
    u11us_(&a[a_offset], mda, m, n, &re[1], &w[m4], mode, np, krank, ksure, &
	    w[m1], &w[m2], &w[m3], &iwork[m1], &iwork[m2]);
    goto L400;
...
/* L220: */
    ...
    u11us_(&a[a_offset], mda, m, n, &w[m4], &ae[1], mode, np, krank, ksure, &
	    w[m1], &w[m2], &w[m3], &iwork[m1], &iwork[m2]);
    goto L400;
...
/* L320: */
    ...
    u11us_(&a[a_offset], mda, m, n, &re[1], &ae[1], mode, np, krank, ksure, &
	    w[m1], &w[m2], &w[m3], &iwork[m1], &iwork[m2]);
...
/*     SOLUTION PHASE */
    ...
    u12us_(&a[a_offset], mda, m, n, &b[b_offset], mdb, nb, mode, krank, &
...
L501:
    xermsg_("SLATEC", "ULSIA", "SOLUTION ONLY (INFO=1) BUT NO RIGHT HAND SID"
	    "E (NB=0)", &c__1, &c__0, (ftnlen)6, (ftnlen)5, (ftnlen)52);
    return 0;
L502:
    xermsg_("SLATEC", "ULSIA", "M.LT.1", &c__2, &c__1, (ftnlen)6, (ftnlen)5, (
	    ftnlen)6);
    return 0;
L503:
    xermsg_("SLATEC", "ULSIA", "N.LT.1", &c__2, &c__1, (ftnlen)6, (ftnlen)5, (
	    ftnlen)6);
    return 0;
L504:
    xermsg_("SLATEC", "ULSIA", "N.LT.M", &c__2, &c__1, (ftnlen)6, (ftnlen)5, (
	    ftnlen)6);
    return 0;
L505:
    xermsg_("SLATEC", "ULSIA", "MDA.LT.M", &c__2, &c__1, (ftnlen)6, (ftnlen)5,
	     (ftnlen)8);
    return 0;
L506:
    xermsg_("SLATEC", "ULSIA", "LIW.LT.M+N", &c__2, &c__1, (ftnlen)6, (ftnlen)
	    5, (ftnlen)10);
    return 0;
L507:
    xermsg_("SLATEC", "ULSIA", "NB.LT.0", &c__2, &c__1, (ftnlen)6, (ftnlen)5, 
	    (ftnlen)7);
    return 0;
L508:
    xermsg_("SLATEC", "ULSIA", "MDB.LT.N", &c__2, &c__1, (ftnlen)6, (ftnlen)5,
	     (ftnlen)8);
    return 0;
L509:
    xermsg_("SLATEC", "ULSIA", "KEY OUT OF RANGE", &c__2, &c__1, (ftnlen)6, (
	    ftnlen)5, (ftnlen)16);
    return 0;
L510:
    xermsg_("SLATEC", "ULSIA", "INSUFFICIENT WORK SPACE", &c__8, &c__1, (
	    ftnlen)6, (ftnlen)5, (ftnlen)23);
    *info = -1;
    return 0;
L511:
    xermsg_("SLATEC", "ULSIA", "RE(I) .LT. 0", &c__2, &c__1, (ftnlen)6, (
	    ftnlen)5, (ftnlen)12);
    return 0;
L512:
    xermsg_("SLATEC", "ULSIA", "RE(I) .GT. 1", &c__2, &c__1, (ftnlen)6, (
	    ftnlen)5, (ftnlen)12);
    return 0;
L513:
    xermsg_("SLATEC", "ULSIA", "AE(I) .LT. 0", &c__2, &c__1, (ftnlen)6, (
	    ftnlen)5, (ftnlen)12);
    return 0;
L514:
    xermsg_("SLATEC", "ULSIA", "INFO OUT OF RANGE", &c__2, &c__1, (ftnlen)6, (
	    ftnlen)5, (ftnlen)17);
    return 0;
L515:
    xermsg_("SLATEC", "ULSIA", "MODE OUT OF RANGE", &c__2, &c__1, (ftnlen)6, (
	    ftnlen)5, (ftnlen)17);
    return 0;
L516:
    xermsg_("SLATEC", "ULSIA", "NP OUT OF RANGE", &c__2, &c__1, (ftnlen)6, (
	    ftnlen)5, (ftnlen)15);
    return 0;
} /* ulsia_ */
