/* sbocls.f -- translated by f2c (version 12.02.01).
...
/* DECK SBOCLS */
/* Subroutine */ int sbocls_(real *w, integer *mdw, integer *mcon, integer *
	mrows, integer *ncols, real *bl, real *bu, integer *ind, integer *
	iopt, real *x, real *rnormc, real *rnorm, integer *mode, real *rw, 
	integer *iw)
{
    /* Initialized data */
    ...
    static integer llb;
    static real one;
    static integer lds, iiw, liw, llx, irw, lrw, lbou, lmdw, lndw, mdwl, nerr,
	     lenx, lliw;
    extern doublereal sdot_(integer *, real *, integer *, real *, integer *);
    static integer mnew, jopt[5], lopt;
    static real zero;
    static integer mopt, llrw, mout;
    static char xern1[8], xern2[8], xern3[16], xern4[16];
    extern doublereal snrm2_(integer *, real *, integer *);
    static integer icase, modec;
    static logical accum;
    extern /* Subroutine */ int sscal_(integer *, real *, real *, integer *);
    static real anorm, cnorm;
    static integer lboum;
    extern /* Subroutine */ int sbols_(real *, integer *, integer *, integer *
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOCLS", ch__1, &c__53, &c__1, (ftnlen)6, (
		    ftnlen)6, (ftnlen)32);
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOCLS", ch__2, &c__54, &c__1, (ftnlen)6, (
		    ftnlen)6, (ftnlen)36);
/*     DO(RETURN TO USER PROGRAM UNIT) */
	    goto L260;
	}
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOCLS", ch__3, &c__55, &c__1, (ftnlen)6, (
		    ftnlen)6, (ftnlen)56);
/*     DO(RETURN TO USER PROGRAM UNIT) */
	    goto L260;
	}
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOCLS", ch__4, &c__56, &c__1, (ftnlen)6, (
			ftnlen)6, (ftnlen)37);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
		    ...
		    xermsg_("SLATEC", "SBOCLS", ch__5, &c__57, &c__1, (ftnlen)
...
/* Writing concatenation */
		    ...
		    s_cat(ch__2, a__1, i__1, &c__3, (ftnlen)36);
		    xermsg_("SLATEC", "SBOCLS", ch__2, &c__48, &c__1, (ftnlen)
...
/* Writing concatenation */
		    ...
		    xermsg_("SLATEC", "SBOCLS", ch__6, &c__49, &c__1, (ftnlen)
			    6, (ftnlen)6, (ftnlen)82);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		    goto L260;
		}
		scopy_(ncols, &x[*ncols + iopt[lp + 2]], &c__1, &rw[1], &c__1)
			;
		lenx += *ncols;
		i__2 = *ncols;
		for (j = 1; j <= i__2; ++j) {
			...
			e_wsfi();
			s_wsfi(&io___45);
			do_fio(&c__1, (char *)&rw[j], (ftnlen)sizeof(real));
			e_wsfi();
/* Writing concatenation */
			...
			xermsg_("SLATEC", "SBOCLS", ch__7, &c__50, &c__1, (
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOCLS", ch__8, &c__51, &c__1, (ftnlen)6, (
		    ftnlen)6, (ftnlen)40);
/*     DO(RETURN TO USER PROGRAM UNIT) */
	    goto L260;
	}
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOCLS", ch__9, &c__41, &c__1, (ftnlen)6, (
			ftnlen)6, (ftnlen)89);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOCLS", ch__10, &c__42, &c__1, (ftnlen)6, 
			(ftnlen)6, (ftnlen)76);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOCLS", ch__11, &c__43, &c__1, (ftnlen)6, 
			(ftnlen)6, (ftnlen)96);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
		...
		i__5[1] = 8, a__4[1] = xern1;
		i__5[2] = 33, a__4[2] = " MUST BE .GE. THE REQD. LENGTH = ";
		i__5[3] = 8, a__4[3] = xern2;
		s_cat(ch__12, a__4, i__5, &c__4, (ftnlen)72);
		xermsg_("SLATEC", "SBOCLS", ch__12, &c__44, &c__1, (ftnlen)6, 
			(ftnlen)6, (ftnlen)72);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
		...
		xermsg_("SLATEC", "SBOCLS", ch__13, &c__45, &c__1, (ftnlen)6, 
			(ftnlen)6, (ftnlen)71);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
		...
		i__5[3] = 8, a__4[3] = xern2;
		s_cat(ch__13, a__4, i__5, &c__4, (ftnlen)71);
		xermsg_("SLATEC", "SBOCLS", ch__13, &c__46, &c__1, (ftnlen)6, 
			(ftnlen)6, (ftnlen)71);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
		...
		i__5[1] = 8, a__4[1] = xern1;
		i__5[2] = 30, a__4[2] = " MUST BE .GE. THE REQD. LEN = ";
		i__5[3] = 8, a__4[3] = xern2;
		s_cat(ch__12, a__4, i__5, &c__4, (ftnlen)72);
		xermsg_("SLATEC", "SBOCLS", ch__12, &c__47, &c__1, (ftnlen)6, 
			(ftnlen)6, (ftnlen)72);
/*     DO(RETURN TO USER PROGRAM UNIT) */
		goto L260;
	    }
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SBOCLS", ch__14, &c__52, &c__1, (ftnlen)6, (
		    ftnlen)6, (ftnlen)68);
...
/*     PROGRAM UNITS. */
    ...
    iiw = 1;
    if (accum || pretri) {
	sbols_(&w[*mcon + 1 + w_dim1], mdw, &mout, ncols, &bl[1], &bu[1], &
...
/*     MOVE RIGHT HAND SIDE OF LEAST SQUARES EQUATIONS. */
    scopy_(&mout, &w[*mcon + 1 + (*ncols + 1) * w_dim1], &c__1, &w[*mcon + 1 
...
/*     PROJECT THE LINEAR CONSTRAINTS INTO A REACHABLE SET. */
	...
	for (i__ = 1; i__ <= i__2; ++i__) {
	    scopy_(ncols, &w[i__ + w_dim1], mdw, &w[*mcon + 1 + (*ncols + i__)
		     * w_dim1], &c__1);
/* L60: */
	}
...
/*      PLACE (-)IDENTITY MATRIX AFTER CONSTRAINT DATA. */
	...
	for (j = *ncols + 1; j <= i__2; ++j) {
	    w[j * w_dim1 + 1] = zero;
	    scopy_(mcon, &w[j * w_dim1 + 1], &c__0, &w[j * w_dim1 + 1], &c__1)
		    ;
/* L70: */
	}
	w[(*ncols + 1) * w_dim1 + 1] = -one;
	i__2 = *mdw + 1;
	scopy_(mcon, &w[(*ncols + 1) * w_dim1 + 1], &c__0, &w[(*ncols + 1) * 
		w_dim1 + 1], &i__2);
...
/*     OBTAIN A 'FEASIBLE POINT' FOR THE LINEAR CONSTRAINTS. */
	...
	iiw = 1;
	i__2 = *ncols + *mcon;
	sbols_(&w[w_offset], mdw, mcon, &i__2, &bl[1], &bu[1], &ind[1], jopt, 
...
/*     CAN BE REACHED. */
	...
	for (j = *ncols + 1; j <= i__2; ++j) {
	    icase = ind[j];
	    if (icase < 4) {
		t = sdot_(ncols, &w[*mcon + 1 + j * w_dim1], &c__1, &x[1], &
			c__1);
	    }
	    switch (icase) {
		case 1:  goto L80;
...
/*     MOVE CONSTRAINT DATA BACK TO THE ORIGINAL AREA. */
	i__2 = *ncols + *mcon;
	for (j = *ncols + 1; j <= i__2; ++j) {
	    scopy_(ncols, &w[*mcon + 1 + j * w_dim1], &c__1, &w[j - *ncols + 
		    w_dim1], mdw);
/* L140: */
	}
    }
	...
	for (j = *ncols + 1; j <= i__2; ++j) {
	    ...
	    scopy_(&mout, &w[*mcon + 1 + j * w_dim1], &c__0, &w[*mcon + 1 + j 
		    * w_dim1], &c__1);
/* L150: */
	}
...
/*     COMPUTE NOMINAL COLUMN SCALING FOR THE UNWEIGHTED MATRIX. */
    ...
    i__2 = *ncols;
    for (j = 1; j <= i__2; ++j) {
	t1 = sasum_(mcon, &w[j * w_dim1 + 1], &c__1);
	t2 = sasum_(&mout, &w[*mcon + 1 + w_dim1], &c__1);
	t = t1 + t2;
	if (t == zero) {
	    t = one;
	}
...
L190:
    ...
    for (j = 1; j <= i__2; ++j) {
	i__6 = *mcon + mout;
	t = snrm2_(&i__6, &w[j * w_dim1 + 1], &c__1);
	if (t == zero) {
	    t = one;
	}
	x[*ncols + *mcon + j] = one / t;
...
L210:
    x[*ncols + *mcon + 1] = one;
    scopy_(ncols, &x[*ncols + *mcon + 1], &c__0, &x[*ncols + *mcon + 1], &
	    c__1);
    goto L230;
/*     CASE 4 */
...
L220:
    scopy_(ncols, &rw[1], &c__1, &x[*ncols + *mcon + 1], &c__1);
L230:
    i__2 = *ncols + *mcon;
    for (j = *ncols + 1; j <= i__2; ++j) {
	x[*ncols + *mcon + j] = one;
...
/*     WEIGHT THE LEAST SQUARES EQUATIONS. */
    ...
    i__2 = mout;
    for (i__ = 1; i__ <= i__2; ++i__) {
	sscal_(ncols, &wt, &w[i__ + *mcon + w_dim1], mdw);
/* L250: */
    }
    sscal_(&mout, &wt, &w[*mcon + 1 + (*mcon + *ncols + 1) * w_dim1], &c__1);
    lrw = 1;
    liw = 1;
...
/*     WHEN MAKING LINEAR INDEPENDENCE TEST. */
    ...
    m = mout + *mcon;
    i__2 = *ncols + *mcon;
    sbols_(&w[w_offset], mdw, &m, &i__2, &bl[1], &bu[1], &ind[1], &iopt[lbou],
