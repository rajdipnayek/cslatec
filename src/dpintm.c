/* dpintm.f -- translated by f2c (version 12.02.01).
...
/* DECK DPINTM */
/* Subroutine */ int dpintm_(integer *m, integer *n, doublereal *sx, integer *
	ix, integer *lmx, integer *ipagef)
{
    /* Initialized data */
...
/*     CHECK FOR INPUT ERRORS. */
    ...
    nerr = 55;
    xermsg_("SLATEC", "DPINTM", "MATRIX DIMENSION M OR N .LE. 0", &nerr, &
...
L20002:
    ...
    nerr = 55;
    xermsg_("SLATEC", "DPINTM", "THE VALUE OF LMX IS TOO SMALL", &nerr, &iopt,
