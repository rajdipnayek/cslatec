/* dgmres.f -- translated by f2c (version 12.02.01).
...
/* DECK DGMRES */
/* Subroutine */ int dgmres_(integer *n, doublereal *b, doublereal *x, 
	integer *nelt, integer *ia, integer *ja, doublereal *a, integer *isym,
	 S_fp matvec, S_fp msolve, integer *itol, doublereal *tol, integer *
	itmax, integer *iter, doublereal *err, integer *ierr, integer *iunit, 
	doublereal *sb, doublereal *sx, doublereal *rgwk, integer *lrgw, 
	integer *igwk, integer *ligw, doublereal *rwork, integer *iwork)
{
    ...
    static integer iflag, jscal;
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    static integer nrmax;
    extern doublereal d1mach_(integer *);
    static integer nrsts, maxlp1;
    extern /* Subroutine */ int dpigmr_(integer *, doublereal *, doublereal *,
	     doublereal *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, S_fp, S_fp, integer *, doublereal *, 
...
/*   ------------------------------------------------------------------ */
    dpigmr_(n, &rgwk[lr], &sb[1], &sx[1], &jscal, &maxl, &maxlp1, &kmp, &
