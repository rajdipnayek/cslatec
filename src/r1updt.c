/* r1updt.f -- translated by f2c (version 12.02.01).
...
/* DECK R1UPDT */
/* Subroutine */ int r1updt_(integer *m, integer *n, real *s, integer *ls, 
	real *u, real *v, real *w, logical *sing)
{
    /* Initialized data */
    ...
    static real tan__;
    static integer nmj;
    static real cos__, sin__, tau, temp, giant, cotan;
