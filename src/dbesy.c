/* dbesy.f -- translated by f2c (version 12.02.01).
...
/* DECK DBESY */
/* Subroutine */ int dbesy_(doublereal *x, doublereal *fnu, integer *n, 
	doublereal *y)
{
    /* Initialized data */
    ...
    static doublereal s, w[2], s1, s2;
    static integer nb;
    static doublereal cn;
    static integer nd;
    static doublereal fn;
    static integer nn;
    static doublereal tm, wk[7], w2n, ran;
    static integer nud;
    static doublereal dnu, azn, trx, xxn, elim;
    static integer iflw;
    static doublereal xlim, flgjy;
    extern doublereal d1mach_(integer *);
    extern integer i1mach_(integer *);
    extern doublereal dbesy0_(doublereal *), dbesy1_(doublereal *);
    extern /* Subroutine */ int dyairy_();
    extern /* Subroutine */ int dasyjy_(U_fp, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, doublereal *, integer *), 
	    dbsynu_(doublereal *, doublereal *, integer *, doublereal *), 
...
/*     ASYMPTOTIC EXPANSION FOR ORDERS FNU AND FNU+1.GE.NULIM */
    ...
    flgjy = -1.;
    dasyjy_((U_fp)dyairy_, x, fnu, &flgjy, &nn, &y[1], wk, &iflw);
    if (iflw != 0) {
	goto L170;
    }
    if (nn == 1) {
