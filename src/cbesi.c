/* cbesi.f -- translated by f2c (version 12.02.01).
...
/* DECK CBESI */
/* Subroutine */ int cbesi_(complex *z__, real *fnu, integer *kode, integer *
	n, complex *cy, integer *nz, integer *ierr)
{
    ...
    static real s1, s2, aa, bb, fn, az;
    static integer nn;
    static real rl;
    static complex zn;
    static real xx, yy, dig, arg, r1m5;
    static integer inu;
    static real tol, alim, elim;
    static complex csgn;
    static real atol, fnul, rtol, ascle;
