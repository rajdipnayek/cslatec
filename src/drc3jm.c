/* drc3jm.f -- translated by f2c (version 12.02.01).
...
/*  Check error conditions 1, 2, and 3. */
	...
	*ier = 1;
	xermsg_("SLATEC", "DRC3JM", "L1-ABS(M1) less than zero or L1+ABS(M1)"
		" not integer.", ier, &c__1, (ftnlen)6, (ftnlen)6, (ftnlen)52);
	return 0;
    } else if (*l1 + *l2 - *l3 < -eps || *l1 - *l2 + *l3 < -eps || -(*l1) + *
	    l2 + *l3 < -eps) {
	*ier = 2;
	xermsg_("SLATEC", "DRC3JM", "L1, L2, L3 do not satisfy triangular co"
		"ndition.", ier, &c__1, (ftnlen)6, (ftnlen)6, (ftnlen)47);
	return 0;
