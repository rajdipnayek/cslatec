/* ssluom.f -- translated by f2c (version 12.02.01).
	...
	iwork, integer *leniw)
{
    ...
    static integer locap, locnc, locil, locjl, locdz, lociu, lociw, locju, 
	    locnr;
...
/*         Perform the incomplete LU preconditioned OrthoMin algorithm. */
    somn_(n, &b[1], &x[1], nelt, &ia[1], &ja[1], &a[1], isym, (U_fp)ssmv_, (
	    U_fp)sslui_, nsave, itol, tol, itmax, iter, err, ierr, iunit, &
