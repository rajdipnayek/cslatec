/* dbsi1e.f -- translated by f2c (version 12.02.01).
...
doublereal dbsi1e_(doublereal *x)
{
    ...
    static doublereal ai1cs[46] = { -.02846744181881478674100372468307,
    ...
    static doublereal ai12cs[69] = { .02857623501828012047449845948469,
...
/* ***FIRST EXECUTABLE STATEMENT  DBSI1E */
	...
	nti1 = initds_(bi1cs, &c__17, &eta);
	ntai1 = initds_(ai1cs, &c__46, &eta);
	ntai12 = initds_(ai12cs, &c__69, &eta);
