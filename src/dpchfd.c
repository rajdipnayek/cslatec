/* dpchfd.f -- translated by f2c (version 12.02.01).
...
/* DECK DPCHFD */
/* Subroutine */ int dpchfd_(integer *n, doublereal *x, doublereal *f, 
	...
	doublereal *xe, doublereal *fe, doublereal *de, integer *ierr)
{
    ...
    extern /* Subroutine */ int dchfdv_(doublereal *, doublereal *, 
...
/*       ---------------------------------------------------------------- */
    dchfdv_(&x[ir - 1], &x[ir], &f[(ir - 1) * f_dim1 + 1], &f[ir * f_dim1 + 1]
