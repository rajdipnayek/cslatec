/* dllti2.f -- translated by f2c (version 12.02.01).
...
/* DECK DLLTI2 */
/* Subroutine */ int dllti2_(integer *n, doublereal *b, doublereal *x, 
	integer *nel, integer *iel, integer *jel, doublereal *el, doublereal *
	dinv)
{
