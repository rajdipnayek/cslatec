/* ssdcgn.f -- translated by f2c (version 12.02.01).
	...
	leniw)
{
    ...
    extern /* Subroutine */ int scgn_(integer *, real *, real *, integer *, 
	    integer *, integer *, real *, integer *, U_fp, U_fp, U_fp, 
    ...
    extern /* Subroutine */ int ssd2s_(integer *, integer *, integer *, 
...
/*         Perform Conjugate Gradient algorithm on the normal equations. */
    scgn_(n, &b[1], &x[1], nelt, &ia[1], &ja[1], &a[1], isym, (U_fp)ssmv_, (
	    U_fp)ssmtv_, (U_fp)ssdi_, itol, tol, itmax, iter, err, ierr, 
