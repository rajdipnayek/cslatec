/* splpmn.f -- translated by f2c (version 12.02.01).
...
/* DECK SPLPMN */
/* Subroutine */ int splpmn_(U_fp usrmat, integer *mrelas, integer *nvars__, 
	real *costs, real *prgopt, real *dattrv, real *bl, real *bu, integer *
	ind, integer *info, real *primal, real *duals, real *amat, real *csc, 
	real *colnrm, real *erd, real *erp, real *basmat, real *wr, real *rz, 
	real *rg, real *rprim, real *rhs, real *ww, integer *lmx, integer *
	lbm, integer *ibasis, integer *ibb, integer *imat, integer *ibrc, 
	integer *ipr, integer *iwr)
{
    /* Format strings */
...
#define abig (equiv_22 + 2)
    static logical feas;
    static integer ibas, nx0106, idum[1], nx0091, nx0066;
...
#define ropt (equiv_22)
    ...
    static integer nredc;
#define itbrc (equiv_15 + 5)
    static real scalr, theta;
...
#define tolls (equiv_22 + 4)
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    integer *), spopt_(real *, integer *, integer *, integer *, real *
	    , integer *, real *, integer *, logical *);
    static integer jstrt;
    extern /* Subroutine */ int ivout_(integer *, integer *, char *, integer *
	    , ftnlen), svout_(integer *, real *, char *, integer *, ftnlen);
...
#define usrbas (equiv_7 + 1)
    extern /* Subroutine */ int pinitm_(integer *, integer *, real *, integer 
	    *, integer *, integer *), xermsg_(char *, char *, char *, integer 
	    *, integer *, ftnlen, ftnlen, ftnlen);
    static real resnrm;
#define kprint (equiv_15 + 4)
    extern /* Subroutine */ int spinit_(integer *, integer *, real *, real *, 
...
#define mxitlp (equiv_15 + 3)
    extern /* Subroutine */ int splpup_(U_fp, integer *, integer *, real *, 
    ...
    extern /* Subroutine */ int prwpge_(integer *, integer *, integer *, real 
	    *, integer *), splpdm_(integer *, integer *, integer *, integer *,
	     integer *, integer *, integer *, integer *, integer *, integer *,
	     integer *, integer *, integer *, integer *, real *, real *, real 
	    *, real *, real *, real *, real *, real *, logical *, logical *);
    static integer ntries;
    extern /* Subroutine */ int splpce_(integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, real *, real *, real *
	    , real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, logical *, logical *), spincw_(integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, real *, 
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, logical *), pnnzrs_(
	    integer *, real *, integer *, real *, integer *, integer *), 
	    splpfe_(integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, real *, real *, real *, real *, real *, real *, real *,
	     real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, logical *), splpfl_(integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, real *, real *, real *
	    , real *, real *, real *, real *, real *, real *, real *, logical 
	    *, logical *), splpmu_(integer *, integer *, integer *, integer *,
	     integer *, integer *, integer *, integer *, integer *, integer *,
	     integer *, integer *, integer *, integer *, integer *, integer *,
	    ...
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, real *, real *, logical *,
	     logical *, logical *, logical *), sclosm_(integer *);
...
/*     CHECK THAT ANY USER-GIVEN CHANGES ARE WELL-DEFINED. */
    spopt_(&prgopt[1], mrelas, nvars__, info, &csc[1], &ibasis[1], ropt, 
	    intopt, lopt);
    if (! (*info < 0)) {
	goto L20002;
    }
...
L20003:
    pinitm_(mrelas, nvars__, &amat[1], &imat[1], lmx, ipagef);

/*     UPDATE MATRIX DATA AND CHECK BOUNDS FOR CONSISTENCY. */
L20004:
    splpup_((U_fp)usrmat, mrelas, nvars__, &prgopt[1], &dattrv[1], &bl[1], &
...
L20008:
    spinit_(mrelas, nvars__, &costs[1], &bl[1], &bu[1], &ind[1], &primal[1], 
...
L20013:
    ...
    nerr = 23;
    xermsg_("SLATEC", "SPLPMN", "IN SPLP,  A SINGULAR INITIAL BASIS WAS ENCO"
	    "UNTERED.", &nerr, &iopt, (ftnlen)6, (ftnlen)6, (ftnlen)51);
    *info = -nerr;
    goto L30001;
L20014:
    npr005 = 0;
...
L20024:
    ...
    nerr = 24;
    xermsg_("SLATEC", "SPLPMN", "IN SPLP, AN INFEASIBLE INITIAL BASIS WAS EN"
	    "COUNTERED.", &nerr, &iopt, (ftnlen)6, (ftnlen)6, (ftnlen)53);
    *info = -nerr;
    goto L30001;
L20025:
L20021:
...
L20052:
    ...
    nerr = 1;
    xermsg_("SLATEC", "SPLPMN", "IN SPLP, THE PROBLEM APPEARS TO BE INFEASIB"
	    "LE", &nerr, &iopt, (ftnlen)6, (ftnlen)6, (ftnlen)45);
    *info = -nerr;
    goto L20053;
L10001:
    if (! (feas && unbnd)) {
    ...
    nerr = 2;
    xermsg_("SLATEC", "SPLPMN", "IN SPLP, THE PROBLEM APPEARS TO HAVE NO FIN"
	    "ITE SOLUTION.", &nerr, &iopt, (ftnlen)6, (ftnlen)6, (ftnlen)56);
    *info = -nerr;
    goto L20053;
L10002:
    if (! (! feas && unbnd)) {
    ...
    nerr = 3;
    xermsg_("SLATEC", "SPLPMN", "IN SPLP, THE PROBLEM APPEARS TO BE INFEASIB"
	    "LE AND TO HAVE NO FINITE SOLUTION.", &nerr, &iopt, (ftnlen)6, (
	    ftnlen)6, (ftnlen)77);
    *info = -nerr;
L10003:
L20053:
    ...
    size = sasum_(nvars__, &primal[1], &c__1) * anorm;
    size /= sasum_(nvars__, &csc[1], &c__1);
    size += sasum_(mrelas, &primal[*nvars__ + 1], &c__1);
    i__ = 1;
...
L20062:
    if (! (size + (r__1 = primal[i__] - bl[i__], dabs(r__1)) * factor == size)
	    ) {
	goto L20068;
    }
    goto L20058;
...
L10004:
    ...
    goto L20067;
L20063:
    if (! (size + (r__1 = primal[i__] - bu[i__], dabs(r__1)) * factor == size)
	    ) {
	goto L20071;
    }
    goto L20058;
...
L30010:
    rhs[1] = zero;
    scopy_(mrelas, &rhs[1], &c__0, &rhs[1], &c__1);
    j = 1;
...
L20135:
    ...
    svout_(mrelas, &duals[1], "(' BASIC (INTERNAL) DUAL SOLN.')", idg, (
	    ftnlen)32);
    i__1 = *nvars__ + *mrelas;
    svout_(&i__1, &rz[1], "(' REDUCED COSTS')", idg, (ftnlen)18);
L20136:
L20139:
    npr015 = 0;
...
L20142:
    ...
    if (*kprint >= 3) {
	svout_(mrelas, &ww[1], "(' SEARCH DIRECTION')", idg, (ftnlen)21);
    }
    goto L30017;
L20149:
    if (! finite) {
...
L30002:
	...
	do_uio(&c__1, (char *)&amat[i__], (ftnlen)sizeof(real));
    }
    i__2 = lpr;
...
/*     THE PAGES MAY BE RESTORED AT A CONTINUATION OF SPLP(). */
    goto L20317;
/* CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC */
...
L20165:
    uu = .1f;
    splpdm_(mrelas, nvars__, lmx, lbm, &nredc, info, &iopt, &ibasis[1], &imat[
...
L30007:
    ...
    scopy_(mrelas, &primal[*nvars__ + 1], &c__0, &primal[*nvars__ + 1], &c__1)
	    ;
    i__ = 1;
    n20172 = *mrelas;
    goto L20173;
...
L20179:
    ...
    k = 0;
L20188:
    pnnzrs_(&k, &aij, &iplace, &amat[1], &imat[1], &j);
    if (! (k <= 0)) {
	goto L20190;
    }
    goto L20189;
...
L20195:
    ...
    splpce_(mrelas, nvars__, lmx, lbm, &itlp, itbrc, &ibasis[1], &imat[1], &
...
/* ++  CODE FOR OUTPUT=YES IS ACTIVE */
    ...
    svout_(mrelas, &erp[1], "(' EST. ERROR IN PRIMAL COMPS.')", idg, (ftnlen)
	    32);
    svout_(mrelas, &erd[1], "(' EST. ERROR IN DUAL COMPS.')", idg, (ftnlen)30)
	    ;
L20201:
/* ++  CODE FOR OUTPUT=NO IS INACTIVE */
/* ++  END */
...
L20197:
    nerr = 26;
    xermsg_("SLATEC", "SPLPMN", "IN SPLP, MOVED TO A SINGULAR POINT.  THIS S"
...
L20208:
    resnrm = sasum_(mrelas, &ww[1], &c__1);
...
L30014:
    spincw_(mrelas, nvars__, lmx, lbm, npp, &jstrt, &ibasis[1], &imat[1], &
...
/* Writing concatenation */
    i__3[0] = 26, a__1[0] = "IN SPLP, MAX ITERATIONS = ";
    i__3[1] = 8, a__1[1] = xern1;
    i__3[2] = 46, a__1[2] = " TAKEN.  UP-TO-DATE RESULTS SAVED ON FILE NO. ";
    i__3[3] = 8, a__1[3] = xern2;
    i__3[4] = 28, a__1[4] = ".  IF FILE NO. = 0, NO SAVE.";
    s_cat(ch__1, a__1, i__3, &c__5, (ftnlen)116);
    xermsg_("SLATEC", "SPLPMN", ch__1, &nerr, &iopt, (ftnlen)6, (ftnlen)6, (
	    ftnlen)116);
    *info = -nerr;
    goto L30001;
L20230:
...
L30015:
    splpfe_(mrelas, nvars__, lmx, lbm, &ienter, &ibasis[1], &imat[1], &ibrc[
...
L30017:
    splpfl_(mrelas, nvars__, &ienter, &ileave, &ibasis[1], &ind[1], &ibb[1], &
...
L30018:
    splpmu_(mrelas, nvars__, lmx, lbm, &nredc, info, &ienter, &ileave, &iopt, 
...
L20278:
    primal[1] = zero;
    i__1 = *nvars__ + *mrelas;
    scopy_(&i__1, &primal[1], &c__0, &primal[1], &c__1);
    j = 1;
...
L30003:
    ...
    ivout_(&c__0, idum, "(' 1=VARIABLE HAS ONLY LOWER BOUND.'/              "
	    ...
	    ftnlen)232);
    svout_(nvars__, &costs[1], "(' ARRAY OF COSTS')", idg, (ftnlen)19);
    i__1 = *nvars__ + *mrelas;
    ivout_(&i__1, &ind[1], "(' CONSTRAINT INDICATORS')", idg, (ftnlen)26);
    i__1 = *nvars__ + *mrelas;
    svout_(&i__1, &bl[1], "(' LOWER BOUNDS FOR VARIABLES  (IGNORE UNUSED ENT"
	    "RIES.)')", idg, (ftnlen)57);
    i__1 = *nvars__ + *mrelas;
    svout_(&i__1, &bu[1], "(' UPPER BOUNDS FOR VARIABLES  (IGNORE UNUSED ENT"
	    "RIES.)')", idg, (ftnlen)57);
    if (! (*kprint >= 2)) {
	goto L20302;
    }
...
L20308:
    ivout_(&c__0, idum, "(' MINIMUM REDUCED COST PRICING WAS USED.')", idg, (
	    ftnlen)43);
L20309:
    rdum[0] = sdot_(nvars__, &costs[1], &c__1, &primal[1], &c__1);
    svout_(&c__1, rdum, "(' OUTPUT VALUE OF THE OBJECTIVE FUNCTION')", idg, (
	    ftnlen)43);
    i__1 = *nvars__ + *mrelas;
    svout_(&i__1, &primal[1], "(' THE OUTPUT INDEPENDENT AND DEPENDENT VARIA"
	    "BLES')", idg, (ftnlen)51);
    i__1 = *mrelas + *nvars__;
    svout_(&i__1, &duals[1], "(' THE OUTPUT DUAL VARIABLES')", idg, (ftnlen)
	    30);
    i__1 = *nvars__ + *mrelas;
...
L30021:
    ...
    ivout_(&c__1, idum, "(' INDEX OF VARIABLE LEAVING THE BASIS')", idg, (
	    ftnlen)40);
    rdum[0] = theta;
    svout_(&c__1, rdum, "(' LENGTH OF THE EXCHANGE STEP')", idg, (ftnlen)32);
    if (! (*kprint >= 3)) {
	goto L20311;
    }
    svout_(mrelas, &rprim[1], "(' BASIC (INTERNAL) PRIMAL SOLN.')", idg, (
	    ftnlen)34);
    i__1 = *nvars__ + *mrelas;
    ivout_(&i__1, &ibasis[1], "(' VARIABLE INDICES IN POSITIONS 1-MRELAS ARE"
	    " BASIC.')", idg, (ftnlen)54);
    ...
    svout_(mrelas, &rhs[1], "(' TRANSLATED RHS')", idg, (ftnlen)19);
    svout_(mrelas, &duals[1], "(' BASIC (INTERNAL) DUAL SOLN.')", idg, (
	    ftnlen)32);
L20311:
    goto L20266;
