/* dsdcgn.f -- translated by f2c (version 12.02.01).
...
/* DECK DSDCGN */
/* Subroutine */ int dsdcgn_(integer *n, doublereal *b, doublereal *x, 
	...
	integer *lenw, integer *iwork, integer *leniw)
{
    extern /* Subroutine */ int ds2y_(integer *, integer *, integer *, 
	    integer *, doublereal *, integer *), dcgn_(integer *, doublereal *
	    , doublereal *, integer *, integer *, integer *, doublereal *, 
	    integer *, U_fp, U_fp, U_fp, integer *, doublereal *, integer *, 
    ...
    extern /* Subroutine */ int dsd2s_(integer *, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *), dchkw_(char *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    doublereal *, ftnlen);
    static integer locdz, lociw;
    extern /* Subroutine */ int dsmtv_();
...
/*         Check the workspace allocations. */
    dchkw_("DSDCGN", &lociw, leniw, &locw, lenw, ierr, iter, err, (ftnlen)6);
    if (*ierr != 0) {
	return 0;
    }
...
/*         used as the preconditioner. */
    dsd2s_(n, nelt, &ia[1], &ja[1], &a[1], isym, &rwork[1]);

/*         Perform Conjugate Gradient algorithm on the normal equations. */
    dcgn_(n, &b[1], &x[1], nelt, &ia[1], &ja[1], &a[1], isym, (U_fp)dsmv_, (
	    U_fp)dsmtv_, (U_fp)dsdi_, itol, tol, itmax, iter, err, ierr, 
