/* djairy.f -- translated by f2c (version 12.02.01).
...
/* DECK DJAIRY */
/* Subroutine */ int djairy_(doublereal *x, doublereal *rx, doublereal *c__, 
	doublereal *ai, doublereal *dai)
{
    /* Initialized data */

    static integer n1 = 14;
    static doublereal con2 = 5.03154716196777;
    static doublereal con3 = .380004589867293;
    static doublereal con4 = .833333333333333;
    static doublereal con5 = .866025403784439;
    static doublereal ak1[14] = { .220423090987793,-.1252902427877,
    ...
    static doublereal ak2[23] = { .274366150869598,.00539790969736903,
	    ...
	    ;
    static doublereal ak3[14] = { .280271447340791,-.00178127042844379,
	    ...
	    ;
    static doublereal ajp[19] = { .0778952966437581,-.184356363456801,
    ...
    static doublereal ajn[19] = { .0380497887617242,-.245319541845546,
    ...
    static doublereal a[15] = { .490275424742791,.00157647277946204,
    ...
    static doublereal b[15] = { .278593552803079,-.00352915691882584,
    ...
    static doublereal dak1[14] = { .204567842307887,-.0661322739905664,
    ...
    static doublereal dak2[24] = { .29333234388323,-.00806196784743112,
    ...
    static doublereal dak3[14] = { .284675828811349,.0025307307261908,
    ...
    static doublereal dajp[19] = { .0653219131311457,-.120262933688823,
    ...
    static doublereal dajn[19] = { .0108594539632967,.0853313194857091,
    ...
    static doublereal da[15] = { .491627321104601,.00311164930427489,
    ...
    static doublereal db[15] = { -.277571356944231,.0044421283341992,
    ...
    static doublereal t, e1, e2, f1, f2, ec, cv, tt, ccv, scv, rtrx, temp1, 
	    temp2;
