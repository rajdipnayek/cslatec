/* sepx4.f -- translated by f2c (version 12.02.01).
...
/* DECK SEPX4 */
/* Subroutine */ int sepx4_(integer *iorder, real *a, real *b, integer *m, 
	integer *mbdcnd, real *bda, real *alpha, real *bdb, real *beta, real *
	c__, real *d__, integer *n, integer *nbdcnd, real *bdc, real *bdd, 
	U_fp cofx, real *grhs, real *usol, integer *idmn, real *w, real *
	pertrb, integer *ierror)
{
    /* System generated locals */
    integer grhs_dim1, grhs_offset, usol_dim1, usol_offset;

    /* Local variables */
    static integer k, l, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, 
	    i13, log2n;
    extern /* Subroutine */ int chkpr4_(integer *, real *, real *, integer *, 
	    integer *, real *, real *, integer *, integer *, U_fp, integer *, 
	    integer *), speli4_(integer *, real *, real *, integer *, integer 
	    *, real *, real *, real *, real *, real *, real *, integer *, 
	    integer *, real *, real *, U_fp, real *, real *, real *, real *, 
	    real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, real *, integer *, real *, real *, integer *);
    static integer length, linput, loutpt;
...
/* ***FIRST EXECUTABLE STATEMENT  SEPX4 */
    ...
    /* Function Body */
    chkpr4_(iorder, a, b, m, mbdcnd, c__, d__, n, nbdcnd, (U_fp)cofx, idmn, 
	    ierror);
    if (*ierror != 0) {
	return 0;
    }
...
/*     ESTIMATE LOG BASE 2 OF N */
    log2n = (integer) (log((real) (*n + 1)) / log(2.f) + .5f);
    length = (*n + 1 << 2) + (log2n + 10) * (*m + 1);
    *ierror = 11;
...
/*     SET WORK SPACE INDICES */
    ...
    i12 = i11 + k;
    i13 = 2;
    speli4_(iorder, a, b, m, mbdcnd, &bda[1], alpha, &bdb[1], beta, c__, d__, 
	    n, nbdcnd, &bdc[1], &bdd[1], (U_fp)cofx, &w[i1], &w[i2], &w[i3], &
	    w[i4], &w[i5], &w[i6], &w[i7], &w[i8], &w[i9], &w[i10], &w[i11], &
	    w[i12], &grhs[grhs_offset], &usol[usol_offset], idmn, &w[i13], 
	    pertrb, ierror);
    return 0;
} /* sepx4_ */
