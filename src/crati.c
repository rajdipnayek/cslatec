/* crati.f -- translated by f2c (version 12.02.01).
...
L10:
    ...
    ak = c_abs(&t1) * .5f;
    flam = ak + sqrt(ak * ak - 1.f);
/* Computing MIN */
    r__1 = ap2 / ap1;
    rho = dmin(r__1,flam);
    test = test1 * sqrt(rho / (rho * rho - 1.f));
    itime = 2;
    goto L10;
L20:
    kk = k + 1 - id;
    ak = (real) kk;
    dfnu = *fnu + (*n - 1);
    q__1.r = dfnu, q__1.i = 0.f;
    cdfnu.r = q__1.r, cdfnu.i = q__1.i;
    q__1.r = ak, q__1.i = 0.f;
    t1.r = q__1.r, t1.i = q__1.i;
    r__1 = 1.f / ap2;
