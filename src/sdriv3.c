/* sdriv3.f -- translated by f2c (version 12.02.01).
...
/* DECK SDRIV3 */
/* Subroutine */ int sdriv3_(integer *n, real *t, real *y, S_fp f, integer *
	nstate, real *tout, integer *ntask, integer *nroot, real *eps, real *
	ewt, integer *ierror, integer *mint, integer *miter, integer *impl, 
	integer *ml, integer *mu, integer *mxord, real *hmax, real *work, 
	...
	integer *nde, integer *mxstep, E_fp g, S_fp users, integer *ierflg)
{
    ...
    static real tlast;
    extern /* Subroutine */ int sdntp_(real *, integer *, integer *, integer *
	    , real *, real *, real *, real *);
    static integer iroot;
    extern /* Subroutine */ int sdstp_(real *, S_fp, S_fp, real *, integer *, 
	    integer *, U_fp, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, real *, real *, S_fp, 
	    real *, real *, real *, real *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, real *, real *, real *
	    , real *, logical *, real *, real *, real *, real *, integer *, 
	    integer *, integer *, integer *, integer *, real *, real *, real *
	    , real *, real *, real *, integer *, integer *, integer *), 
	    sdzro_(real *, E_fp, real *, integer *, integer *, integer *, 
    ...
    static icilist io___41 = { 0, rl1, 0, "(E16.8)", 16, 1 };
    static icilist io___43 = { 0, rl2, 0, "(E16.8)", 16, 1 };
    static icilist io___44 = { 0, rl1, 0, "(E16.8)", 16, 1 };
    static icilist io___45 = { 0, rl2, 0, "(E16.8)", 16, 1 };
    static icilist io___51 = { 0, rl1, 0, "(E16.8)", 16, 1 };
    ...
    static icilist io___55 = { 0, rl1, 0, "(E16.8)", 16, 1 };
    static icilist io___56 = { 0, intgr1, 0, "(I8)", 8, 1 };
    static icilist io___57 = { 0, rl2, 0, "(E16.8)", 16, 1 };
    static icilist io___66 = { 0, rl1, 0, "(E16.8)", 16, 1 };
    static icilist io___67 = { 0, rl1, 0, "(E16.8)", 16, 1 };
    static icilist io___68 = { 0, rl1, 0, "(E16.8)", 16, 1 };
...
/* ***FIRST EXECUTABLE STATEMENT  SDRIV3 */
    ...
    if (*nstate == 12) {
	*ierflg = 999;
	xermsg_("SLATEC", "SDRIV3", "Illegal input.  The value of NSTATE is "
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__1, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)54);
	*nstate = 12;
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__2, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)51);
	*nstate = 12;
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__3, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)63);
	*nstate = 12;
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__4, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)57);
	*nstate = 12;
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__5, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)74);
	*nstate = 12;
	return 0;
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__6, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)53);
	*nstate = 12;
	return 0;
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__7, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)52);
	*nstate = 12;
	return 0;
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__8, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)98);
	*nstate = 12;
	return 0;
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__9, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)75);
	*nstate = 12;
	return 0;
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__10, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)156);
	*nstate = 12;
	return 0;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__11, ierflg, &c__1, (ftnlen)6, (ftnlen)
		6, (ftnlen)155);
	*nstate = 12;
	return 0;
    }
...
/*                                      If TROOT .LE. TOUT, report TROOT. */
		...
		if (*tout * hsign >= work[167] * hsign) {
		    troot = work[167];
		    sdntp_(&h__, &c__0, n, &iwork[12], t, &troot, &work[251], 
			    &y[1]);
		    *t = troot;
		    *nstate = 5;
		    *ierflg = 0;
...
L60:
		...
		if (*ntask == 1) {
			...
			if (*tout * hsign >= troot * hsign) {
			    sdntp_(&h__, &c__0, n, &iwork[12], t, &troot, &
				    work[251], &y[1]);
			    *nstate = 5;
			    *t = troot;
			    *ierflg = 0;
...
/*                                     than a root, set IJROOT to zero. */
			...
			sdntp_(&h__, &c__0, n, &iwork[12], t, &troot, &work[
				251], &y[1]);
			*nstate = 5;
			*ierflg = 0;
			*t = troot;
	...
	*nstate = 2;
	if (*t * hsign >= *tout * hsign) {
	    sdntp_(&h__, &c__0, n, &iwork[12], t, tout, &work[251], &y[1]);
	    *t = *tout;
	    *ierflg = 0;
	    goto L580;
	}
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SDRIV3", ch__12, ierflg, &c__0, (ftnlen)6, (
		    ftnlen)6, (ftnlen)128);
	    *nstate = 11;
	    sdntp_(&h__, &c__0, n, &iwork[12], t, tout, &work[251], &y[1]);
	    *t = *tout;
...
/* L280: */
	    work[i__ + iywt - 1] = (r__1 = y[i__], dabs(r__1));
	}
	goto L410;
L290:
	if (iwork[9] == 0) {
		...
		*nstate = 6;
		...
		if (*miter == 1 || *miter == 2) {
			...
			*nstate = 9;
		    ...
		    sgefa_(&work[ia], &matdim, n, &iwork[51], &info);
		    if (info != 0) {
			goto L690;
		    }
		    sgesl_(&work[ia], &matdim, n, &iwork[51], &work[isave2], &
			    c__0);
		} else if (*miter == 4 || *miter == 5) {
			...
			*nstate = 9;
		    ...
		    sgbfa_(&work[ia], &matdim, n, ml, mu, &iwork[51], &info);
		    if (info != 0) {
			goto L690;
		    }
		    sgbsl_(&work[ia], &matdim, n, ml, mu, &iwork[51], &work[
			    isave2], &c__0);
		}
	    } else if (*impl == 2) {
...
/* L340: */
		...
		if (*miter == 1 || *miter == 2) {
			...
			*nstate = 9;
		    ...
		    sgefa_(&work[ia], &matdim, nde, &iwork[51], &info);
		    if (info != 0) {
			goto L690;
		    }
		    sgesl_(&work[ia], &matdim, nde, &iwork[51], &work[isave2],
			     &c__0);
		} else if (*miter == 4 || *miter == 5) {
		    (*fa)(&npar, t, &y[1], &work[ia + *ml], &matdim, ml, mu, &
			    ndecom);
			...
			*nstate = 9;
		    ...
		    sgbfa_(&work[ia], &matdim, nde, ml, mu, &iwork[51], &info)
			    ;
		    if (info != 0) {
			goto L690;
		    }
		    sgbsl_(&work[ia], &matdim, nde, ml, mu, &iwork[51], &work[
			    isave2], &c__0);
		}
	    }
	}
	...
	for (j = i__; j <= i__3; ++j) {
	    if (y[j] != 0.f) {
		work[j + iywt - 1] = (r__1 = y[j], dabs(r__1));
	    } else {
		if (iwork[9] == 0) {
		    work[j + iywt - 1] = (r__1 = h__ * work[j + isave2 - 1], 
			    dabs(r__1));
		} else {
		    work[j + iywt - 1] = (r__1 = work[j + 251 + *n - 1], dabs(
			    r__1));
		}
	    }
	    if (work[j + iywt - 1] == 0.f) {
...
/* L380: */
/* Computing MAX */
	    r__2 = ewt[1], r__3 = (r__1 = y[i__], dabs(r__1));
	    work[i__ + iywt - 1] = dmax(r__2,r__3);
	}
    } else if (*ierror == 4) {
	i__3 = *n;
	for (i__ = 1; i__ <= i__3; ++i__) {
/* L400: */
/* Computing MAX */
	    r__2 = ewt[i__], r__3 = (r__1 = y[i__], dabs(r__1));
	    work[i__ + iywt - 1] = dmax(r__2,r__3);
	}
    }
...
/* L420: */
    ...
    sum = snrm2_(n, &work[isave2], &c__1) / sqrt((real) (*n));
    sum = dmax(1.f,sum);
    if (*eps < sum * uround) {
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__13, ierflg, &c__0, (ftnlen)6, (ftnlen)
		6, (ftnlen)145);
	*nstate = 4;
	goto L560;
    }
...
/* Writing concatenation */
	...
	xermsg_("SLATEC", "SDRIV3", ch__14, ierflg, &c__0, (ftnlen)6, (ftnlen)
		6, (ftnlen)196);
	iwork[21] = 1;
    }
    if (*ntask != 2) {
...
/* Writing concatenation */
	    ...
	    xermsg_("SLATEC", "SDRIV3", ch__15, ierflg, &c__0, (ftnlen)6, (
		    ftnlen)6, (ftnlen)96);
	    *nstate = 3;
	    goto L560;
	}
...
/*    8            MXRDSV) */
    ...
    sdstp_(eps, (S_fp)f, (S_fp)fa, &work[161], impl, ierror, (U_fp)jacobn, &
		...
		*nstate = 7;
		...
		if (gnow == 0.f) {
			...
			if (dabs(hused) >= uround * dabs(*t)) {
			    ...
			    iroot = i__;
			    troot = *t;
			    sdzro_(&ae, (E_fp)g, &h__, &npar, &iwork[12], &
...
/* L510: */
		...
		sdntp_(&h__, &c__0, n, &iwork[12], t, &troot, &work[251], &y[
			1]);
		*nstate = 5;
		*t = troot;
		*ierflg = 0;
...
/*                                            SIZE = ABS(ERROR(I)/YWT(I)) */
	size = (r__1 = work[i__ + isave1 - 1] / work[i__ + iywt - 1], dabs(
		r__1));
	if (big < size) {
	    big = size;
	    imxerr = i__;
...
/* Writing concatenation */
    ...
    xermsg_("SLATEC", "SDRIV3", ch__16, ierflg, &c__1, (ftnlen)6, (ftnlen)6, (
	    ftnlen)119);
    *nstate = 12;
    return 0;
...
/* Writing concatenation */
    ...
    xermsg_("SLATEC", "SDRIV3", ch__11, ierflg, &c__1, (ftnlen)6, (ftnlen)6, (
	    ftnlen)155);
    *nstate = 12;
    return 0;
...
/* Writing concatenation */
    ...
    xermsg_("SLATEC", "SDRIV3", ch__17, ierflg, &c__1, (ftnlen)6, (ftnlen)6, (
	    ftnlen)64);
    *nstate = 12;
    return 0;
} /* sdriv3_ */
