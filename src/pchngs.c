/* pchngs.f -- translated by f2c (version 12.02.01).
...
/* DECK PCHNGS */
/* Subroutine */ int pchngs_(integer *ii, real *xval, integer *iplace, real *
...
/*     CHECK VALIDITY OF ROW/COL. INDEX. */
    ...
    nerr = 55;
    xermsg_("SLATEC", "PCHNGS", "IRCX=0.", &nerr, &iopt, (ftnlen)6, (ftnlen)6,
	     (ftnlen)7);
L20002:
    lmx = ix[1];
...
/*     THE INDEX MUST BE .LE. N. */
    ...
    nerr = 55;
    xermsg_("SLATEC", "PCHNGS", "SUBSCRIPTS FOR ARRAY ELEMENT TO BE ACCESSED"
