/* dqrslv.f -- translated by f2c (version 12.02.01).
...
/* DECK DQRSLV */
/* Subroutine */ int dqrslv_(integer *n, doublereal *r__, integer *ldr, 
	integer *ipvt, doublereal *diag, doublereal *qtb, doublereal *x, 
	doublereal *sigma, doublereal *wa)
{
    /* Initialized data */
...
/*           APPROPRIATE ELEMENT IN THE CURRENT ROW OF D. */
	    ...
	    if ((d__1 = r__[k + k * r_dim1], abs(d__1)) >= (d__2 = sigma[k], 
		    abs(d__2))) {
		goto L40;
	    }
