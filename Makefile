...
CFLAGS=-O2 -fPIC -Wall -Wno-parentheses -Wno-maybe-uninitialized -Wno-unused-but-set-variable
...
src/bandv.o src/bcrh.o src/bdiff.o src/besi0e.o src/besi0.o src/besi1e.o \
src/besi1.o src/besi.o src/besj0.o src/besj1.o src/besj.o src/besk0e.o \
src/besk0.o src/besk1e.o src/besk1.o src/beskes.o src/besk.o src/besknu.o \
src/besks.o src/besy0.o src/besy1.o src/besy.o src/besynu.o src/beta.o \
src/betai.o src/bfqad.o src/bie.o src/bi.o src/binom.o src/bint4.o \
...
src/chpr.o src/chpsl.o src/chu.o src/cinvit.o src/ckscl.o src/clbeta.o \
...
src/comhes.o src/comlr2.o src/comlr.o src/compb.o src/comqr2.o src/comqr.o \
src/cortb.o src/corth.o src/cosdg.o src/cosgen.o src/cosqb1.o src/cosqb.o \
src/cosqf1.o src/cosqf.o src/cosqi.o src/cost.o src/costi.o src/cot.o \
...
src/daxpy.o src/dbcg.o src/dbdiff.o src/dbesi0.o src/dbesi1.o src/dbesi.o \
src/dbesj0.o src/dbesj1.o src/dbesj.o src/dbesk0.o src/dbesk1.o src/dbesk.o \
src/dbesks.o src/dbesy0.o src/dbesy1.o src/dbesy.o src/dbeta.o src/dbetai.o \
src/dbfqad.o src/dbhin.o src/dbie.o src/dbi.o src/dbinom.o src/dbint4.o \
...
src/dchfdv.o src/dchfev.o src/dchfie.o src/dchkw.o src/dchud.o src/dchu.o \
...
src/dnbco.o src/dnbdi.o src/dnbfa.o src/dnbfs.o src/dnbsl.o src/dnls1e.o \
src/dnls1.o src/dnrm2.o src/dnsqe.o src/dnsq.o src/dogleg.o src/domn.o \
...
src/dqawo.o src/dqawse.o src/dqaws.o src/dqc25c.o src/dqc25f.o src/dqc25s.o \
...
src/dsdgmr.o src/dsdi.o src/dsdomn.o src/dsdot.o src/dsdscl.o src/dsds.o \
src/dsgs.o src/dsiccg.o src/dsico.o src/dsics.o src/dsidi.o src/dsifa.o \
src/dsilur.o src/dsilus.o src/dsindg.o src/dsisl.o src/dsjac.o src/dsli2.o \
src/dsli.o src/dsllti.o src/dslubc.o src/dslucn.o src/dslucs.o src/dslugm.o \
...
src/orthog.o src/ortran.o src/passb2.o src/passb3.o src/passb4.o src/passb5.o \
...
src/qawse.o src/qaws.o src/qc25c.o src/qc25f.o src/qc25s.o src/qcheb.o \
...
src/radf5.o src/radfg.o src/rand.o src/ratqr.o src/rc3jj.o src/rc3jm.o \
src/rc6j.o src/rc.o src/rd.o src/rebakb.o src/rebak.o src/reduc2.o \
src/reduc.o src/rf.o src/rfftb1.o src/rfftb.o src/rfftf1.o src/rfftf.o \
src/rffti1.o src/rffti.o src/rgauss.o src/rg.o src/rgg.o src/rj.o \
src/rpqr79.o src/rpzero.o src/rsb.o src/rsco.o src/rs.o src/rsgab.o \
...
src/ssifa.o src/ssilur.o src/ssilus.o src/ssisl.o src/ssjac.o src/ssli2.o \
src/ssli.o src/ssllti.o src/sslubc.o src/sslucn.o src/sslucs.o src/sslugm.o \
...
lib/libslatec.a: $(objs)
	mkdir -p lib
	$(CC) $(LDFLAGS) -o /dev/null $(objs) $(libs)
	$(AR) $(ARFLAGS) $@ $(objs)

lib/libslatec-dbvp.a: $(objs_dbvp)
	mkdir -p lib
	$(CC) $(LDFLAGS) -o /dev/null $(objs_dbvp) $(libs)
	$(AR) $(ARFLAGS) $@ $(objs_dbvp)

lib/libslatec-sbvp.a: $(objs_sbvp)
	mkdir -p lib
	$(CC) $(LDFLAGS) -o /dev/null $(objs_sbvp) $(libs)
